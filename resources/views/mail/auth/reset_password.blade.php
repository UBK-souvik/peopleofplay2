...
<html>
	...
	<body style="">
		  ...
		  <div class="container pt-5" style="background-color: #fff;position: relative;min-height: 300px;margin: 0% 20% 0% 20%;">
		    ...
		    <h3 class="">Activate your Profile</h3> 
		    <hr>
		    <p class="mb-1">Hey {{$name}}!</p>
		    <p>We were eagerly waiting for you! Finally, its time to claim your profile, click the "Activate your Account' link below and follow the steps to claim your People of Play profile.</p>
