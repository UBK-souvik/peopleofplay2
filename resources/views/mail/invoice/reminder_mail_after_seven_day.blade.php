...
<body style="background-color: #fff;">
	<div class="container pt-5" style="background-color: #fff;position: relative;width: 650px;min-height: 300px;margin-top: 8%;border:3px solid #662C92;text-align: center;padding: 25px;border-radius: 10px;">
		<div style="position: absolute;top: -60px;left: 37%;transform: translate(0%,0%);">
	    	...
	    	<p>Your POP Account has been expired before 7 days on: {{ $end_date }}. Please renew your account on time in order to continue using People of Play services and content. If you do not renew your account, all of your data will not be deleted, but you just won't be able to edit it.</p>
