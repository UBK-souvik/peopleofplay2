...
<body style="background-color: #fff;">
	  ...
	  <div class="container pt-5" style="background-color: #fff;position: relative;width: 650px;min-height: 300px;margin-top: 8%;border:3px solid #662C92;text-align: center;padding: 25px;border-radius: 10px;">
	    ...
	    <hr> -->
	    <p style="margin-top: 6px;margin-bottom: 10px;font-size: 18px;">Welcome Harsh!</p>
		<p>We noticed you just upgraded your People of Play account from  Old Subscription to New Subscription. It makes us so happy to hear that you are eager to explore POP even more and gain access to brand new features. </p>

		<p>If you have any questions, please email <a href="mailto:info@peopleofplay.com" target="_blank"> info@peopleofplay.com.</a></p>
