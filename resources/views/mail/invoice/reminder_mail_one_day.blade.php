...
<body style="background-color: #fff;">
	  ...
	  <div class="container pt-5" style="background-color: #fff;position: relative;width: 650px;min-height: 300px;margin-top: 8%;border:3px solid #662C92;text-align: center;padding: 25px;border-radius: 10px;">
	    ...
	    <hr> -->
	    <p style="margin-top: 6px;margin-bottom: 10px;font-size: 18px;">Hello <b>{{ $name }}</b>,</p>
		<p>Your POP Account will be expiring today at: {{ $end_date }}. Please renew your account in order to continue using People of Play services and content. If you do not renew your account, all of your data will not be deleted, but you just won't be able to edit it.</p>
		<p>Click on pay now button to renew your account.</p>
		<p class="text-danger">Please ignore it, if already paid.</p>
		<p><a href="{{@$invoice_url}}" class="invoiceUrl btn btn-primary font-weight-bold" target="blank">Pay Now ${{@$price}}</a></p>
