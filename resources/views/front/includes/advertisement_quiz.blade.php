 ...
 $advertisement = \App\Models\Advertisement::where(['advertisement_category' => 7, 'advertisement_position' => 6])
  ...
  <div class="col-md-2">
    <div class="AdsImage">
      <a href="{{@$advertisement->destination_link}}" class="span-style1" target="_blank">
        ...
        <h3 class="imgHead text-center"> {{@$advertisement->sponsor_name}}</h3>
      </a>
    </div>
  </div>
 @endif