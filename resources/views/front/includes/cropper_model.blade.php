                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            {{-- <button type="button" id="cropperDisable" class="btn btn-secondary"><i class="fa fa-search-plus" aria-hidden="true"></i> Cropper disable</button> --}}
