...
<div class="col-md-6 col-lg-7 MiddleColumnSection">
   <div class="YoutubePremieres">
      ...
      <div class="homepagebanner mt-4 text-center">
         <a href="javascript:void(0);" target="_blank"> <img src="{{ asset('front/images/2021_POP_Week_sponsors_January_2022.jpg') }}" alt="POP-Week-sponsors-October-2021" class="img-fluid"></a>
      </div>
   </div>
</div>
...
<script>
   ...
   function memeModel(e,id) {
       var r_url = "{{ route('front.pages.meme') }}";
        $.ajax({
          url: r_url,
          type: 'POST',
          dataType: 'json',
