...
<div class="col-md-9 col-lg-10 MiddleColumnFullWidth">
   <div class="left-column paddingTwenty border_right AdvceSearch">
      <div class="First-column bg-white p-3">
         <!-- New Design -->
         @if(!empty(get_current_user_info()->type_of_user) && get_current_user_info()->type_of_user == 2 && !empty(get_current_user_info()->role) && (get_current_user_info()->role == 2 || get_current_user_info()->role == 3)) 
         <div id="pop-main" class="pop-search-gateway">
            <div class="text-center">
            <img src="{{ asset('front/images/database_advanced_search_header.png') }}" alt="profileimage" class="img-fluid">
           </div>
            ...
            <div class="pop-search-gateway__options">
               ...
               <div class="popArticle pop-search-gateway__link">
                  ...
                  <a href="{{ url('/skills') }}">Browse Skills <i class="fa fa-caret-right ml-2" aria-hidden="true"></i></a>
               </div>
               <div class="popArticle pop-search-gateway__link">
                  ...
                  <a href="{{ url('/roles') }}">Browse Roles <i class="fa fa-caret-right ml-2" aria-hidden="true"></i></a>
               </div>
            </div>
         </div>
         <div class="col-md-12" id="add-edit-user-main-box-body-div">
            <form id="add-edit-user-main-box-body-div" method="post" action="{{route('front.home.site.advance.search.data')}}">
               @csrf
               <!-- <div class="col-md-12"> -->
         ...
         <div class="col-md-12">
            <div class="MainBoxBodyEdit" id="add-edit-user-main-box-body-div2">
               <div class="main-box-body-div">
                  ...
                  <form id="add-edit-user-main-box-body-div2" method="post" action="{{route('front.home.site.advance.search.data')}}">
                     @csrf
                     <div class="advancedSearchPage">
                        <div class="row">
                           <div class="col-md-12 col-lg-6">
                              <div class="form-group mb-0">
                                 <div class="tags-input" id="myTags">
                                    ...
                                    <span class="tag">
                                    <span class="text" _value="Nairobi 047">{{$val}}</span><span class="close">&times;</span>
                                    </span>
                                    @endforeach
                                    @endif
                                    </span>
                           ...
                           <div class="col-md-12 col-lg-6">
                              <div class="form-group mb-0"> 
                                 <select class="form-control" name="collab_user_role" id="collab_user_role">
                                    ...
                                    <option {{(@$request->collab_user_role == $key) ? 'selected' : '' }} value="{{$key}}">{{$value}}</option>
                                    @endforeach
                                 </select>
                              </div>
                           </div>
         ...
         <div class="col-md-12">
            <div class="MainBoxBodyEdit" id="add-edit-user-main-box-body-div4">
               <div class="main-box-body-div">
                  ...
                  <form id="add-edit-user-main-box-body-div4" method="post" action="{{route('front.home.site.advance.search.data')}}" onsubmit="search_Data(this); return false;">
                     @csrf
                     <div class="advancedSearchPage">
                        <div class="row">
         ...
         <p>
            <a class="btnAll" href="{{$str_profile_change_plan}}">Upgrade My Plan</a>
         </p>
         @endif
      </div>
      <div class="First-column bg-white pt-0" id="advance_search_div" @if(empty(@$result_data[0]->name))style="display:none;" @endif>
         @if(!empty($str_category_name))     
         <div class="wrap-text text-white">
            <p class="m-0" style="font-size: 19px;">@if(!empty($str_category_name)) Products in <b>" {{$str_category_name}} "</b> @endif</p>
         </div>
         @else       
         <div class="wrap-text text-white">
            <p class="m-0" style="font-size: 19px;">@if(!empty($search_data)) Results for <b>" {{$search_data}} "</b> @endif</p>
         </div>
         @endif   
         ...
         <div class="row">
            <div class="col-md-12">
               @if(empty($str_category_name))
               <h2 class="sidetitleProducttitle1 pt-3">{{ $slug_prefix_list_child_val['type'] }}</h2>
               @endif
               <table class="table event_table HomeSearch">
                  <tbody>
                     ...
                     <tr class="py-0">
                        <td class="pl-0" style="width:50px !important;"><a target="blank" href="{{$get_search_url_data}}" class="dac_name">
   ...
   $(document).ready(function(){
      $('body').on('click','#add-edit-user-main-box-body-div  #search',function(e){
          ...
          // fd.append('skills', skills);
           ...
           $.ajax({
              url:"{{route('front.home.site.advance.search.data')}}",
            data: fd,
            processData: false,
            contentType: false,
            datatype: 'html',
