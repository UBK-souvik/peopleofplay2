   ...
   <div class="container mx-auto dictionaryContainer">
      <div class="col-md-12">
         <div class="dictionaryHeadBanner text-center">
            <img src="{{ asset('front/images/pop-dic-banner.png') }}" alt="profileimage" class="img-fluid">
         </div>
      </div>
      <div class="col-md-12">
        <div class="row">
        ...
        <div class="row searchDictionary">
           ...
           <div class="col-lg-4 col-sm-6 randomword">
            ...
            <p class="text-white text-center mb-2 mb-lg-0">
              <a href="{{ $str_link_drop_menu_dictionary_random }}" class="btn">Show me a Random Word!</a>
            </p>
         </div>
           </div>
           <div class="col-lg-4 col-sm-6 clickSubmit">
               <div class="clickSubmitInner">
                  <p class="text-white text-center mb-2 mb-lg-0"><a class="text-white btn" href="{{ route('front.user.dictionary.create') }}">Click Here to Submit a Term!</a></p>
               </div>
            </div>
        </div>
      </div>
      ...
      <div class="col-md-12 mt-4">
         <h3 class="headTextDictonary">
            @if($str_current_date_new == @$arr_dictionary_data[5])         
            {{'Word of the day'}}
            @else
            {{'Random Word'}}
            @endif          
         ...
         <div class="col-xl-6 col-md-6">
           ...
           <!--  <div class="col-xl-4 col-md-6 clickSubmit">
               <div class="clickSubmitInner">
                  <p class="text-white text-center mb-0"><a class="text-white" href="{{ route('front.user.dictionary.create') }}">Click Here to Submit a Term!</a></p>
               </div>
            </div> -->
            <div class="col-xl-6 col-md-6 offerImgDictonary">
              <div class="mx-auto starBackground" style="background-image: url('{{ asset('front/images/offerImage.png') }}');">
	  ...
	  @if(!empty($dictionary_list) && count($dictionary_list)>0)
      ...
      <div class="col-md-12">
        <div class="row">
		 ...
		 @foreach($dictionary_list as $dictionary_list_row) 
			 @php
			 ...
			 @endphp
         <div class="col-xl-6 col-md-6">
            <div class="cardBox mb-4" style="background-color: {{$str_dictionary_background_color}};">
              <div class="row">
                <div class="col-md-8 col-8">
                  <h3>{{@$dictionary_list_row->title}}</h3>
                </div>
                      ...
                      <div class="dropdown socialDropdown">
                         ...
                         <div class="dropdown-content1 socialDropdownContent dictionaryShare dropdown-menu">
                            <ul class="dropSocialShare">
                               <li><a href="javascript:void(0);" onclick="return copyToClipboard('#hid_dictionary_url_{{$int_recent_words_count_flag}}');"><i class="fa photo_icon fa-clone"></i></a></li>
                               <li><a target="_blank" href="http://www.facebook.com/sharer.php?u={{$str_dictionary_url}}"><i class="fa photo_icon fa-facebook"></i></a></li>
                               <li><a target="_blank" href="http://twitter.com/share?url={{$str_dictionary_url}}"><i class="fa photo_icon fa-twitter"></i></a></li>
                               <li><a target="_blank" href="https://www.instagram.com/?url={{$str_dictionary_url}}"><i class="fa photo_icon fa-instagram"></i></a></li>
                               <li><a target="_blank" href="https://wa.me/?text={{$str_dictionary_url}}"><i class="fa photo_icon fa-whatsapp"></i></a></li>
                               <input type="hidden" name="hid_dictionary_url_{{$int_recent_words_count_flag}}" id="hid_dictionary_url_{{$int_recent_words_count_flag}}" value="{{$str_dictionary_url}}"> 
							</ul>
                         </div>
                      </div>
                  </div>
               ...
               <div class="mt-3">
                  <p>{{@$dictionary_list_row->description}} </p>
                  <p class="bottomText">Submitted by <a href="{{$str_user_url_new}}">{{@$str_user_name}}</a> on <span>{{@App\Helpers\UtilitiesTwo::get_date_from_date_time_data(@$dictionary_list_row->date_to_be_published)}}</span></p>
               </div>
            </div>
         </div>
         @endforeach
