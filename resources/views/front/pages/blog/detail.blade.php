           ...
           <div class="row sectionTop">
            <div class="col-sm-10 px-0">
              ...
              <div class="mb-0">
                ...
                <p class="mb-0 span-text-grey" ><small class="span-text-grey ml-0 blogDate">@if(!empty($blog_category_name)){{@$blog_category_name}}@endif</small> 
                </p>
              </div>
            </div>
...
{{--
  ...
  <div class="addthis_inline_share_toolbox" data-url="{{$str_current_url}}" data-title="{{$blog->title}}" data-description="" data-media="{{asset(@newsBlogImageBasePath($blog->featured_image))}}"></div>
--}}
...
{{--
  <!-- Go to www.addthis.com/dashboard to customize your tools -->
  <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-60e70a93efff255c"></script>
--}}
