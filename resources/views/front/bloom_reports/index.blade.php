...
@section('style_new')     
   <link href="{{ asset('front/new_css/bloom.css?'.time()) }}" rel="stylesheet">
@endsection
@section('content')
      ...
      <div class="bloomReports w-100 clearfix">
         ...
         <div class="bloomTop pb-4">
            <div class="leftSide">
               ...
               <img src="{{asset('uploads/images/bloom_reports/ukrain.svg')}}" class="img-fluid">
               </a>
               </div>
               <div class="bloomLogo">
               <a href="javascript:void(0);" class="d-inline-block">
               <img src="{{asset('uploads/images/bloom_reports/bloom_logo.jpg')}}" class="img-fluid">
               </a>
            ...
            <div class="shareFB">
               <a href="javascript:void(0);" class="d-inline-block">
               <img src="{{asset('uploads/images/bloom_reports/fb.png')}}" class="img-fluid">
               </a>
            </div>
         </div>
         <div class="bloomBtm">
            <ul class="list-unstyled blmBtnList">
               ...
               <img src="{{asset('uploads/images/bloom_reports/btn_images/1.jpg')}}" class="img-fluid">
               </a>
               </li>
               <li>
               <a href="javascript:void(0);" class="d-block">
               <img src="{{asset('uploads/images/bloom_reports/btn_images/2.jpg')}}" class="img-fluid">
               </a>
               </li>
               <li>
               <a href="javascript:void(0);" class="d-block">
               <img src="{{asset('uploads/images/bloom_reports/btn_images/3.jpg')}}" class="img-fluid">
               </a>
               </li>
               <li>
               <a href="javascript:void(0);" class="d-block">
               <img src="{{asset('uploads/images/bloom_reports/btn_images/4.jpg')}}" class="img-fluid">
               </a>
               </li>
               <li>
               <a href="javascript:void(0);" class="d-block">
               <img src="{{asset('uploads/images/bloom_reports/btn_images/5.jpg')}}" class="img-fluid">
               </a>
               </li>
               <li>
               <a href="javascript:void(0);" class="d-block">
               <img src="{{asset('uploads/images/bloom_reports/btn_images/6.jpg')}}" class="img-fluid">
               </a>
               </li>
            </ul>
         </div>
         ...
         <div class="welcomeNews w-100 clearfix wlcmBorder">
            <div class="blmHeading">
               <h2>{{ucfirst(@$bloomReport['welcome']->title)}}</h2>
            </div>
            <div class="blmContent">
               <div class="d-flex manageFlex">
                  <div class="divOne1">
                  <div class="cntimg mt-md-5">
                     <img src="{{asset('uploads/images/bloom_reports/'.@$bloomReport['welcome']->image)}}" class="img-fluid">
                  </div>
                  </div>
                  <div class="divOne2">
                     <div class="imgContnt">
                        {!! nl2br(@$bloomReport['welcome']->caption) !!}
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="welcomeNews w-100 clearfix wlcmBorder">
            <div class="blmHeading d-flex">
               ...
               <div class="headText">
                  <h2 class="m-0">{{ucfirst(@$bloomReport['person']->title)}}</h2>
                  <h4 class="m-0">{{ucfirst(@$bloomReport['person']->sub_heading)}}</h4>
               </div>
            </div>
            <div class="blmContent">
               <div class="d-flex manageFlex mt-3">
                  <div class="divOne1">
                     <div class="cntimg">
                        <img src="{{asset('uploads/images/bloom_reports/'.@$bloomReport['person']->image)}}" class="img-fluid">
                     </div>
                  </div>
                  <div class="divOne2">
                     <div class="imgContnt">
                        {!! nl2br(@$bloomReport['person']->caption) !!}
                     </div>
                  </div>
               </div>
            </div>
         </div>
         @if(!empty($bloom_news_reports->toArray()))
            <div class="welcomeNews w-100 clearfix wlcmBorder">
               <?php $cdata = $cdata_2 = array(); ?>
               @foreach($bloom_news_reports as $k => $bloom_news_report)  
                     <div class="sepContent">
                        ...
                        ?>
                              <div class="blmHeading d-flex">
                                 <h2 class="m-0">{{ucwords($bloom_news_report->cat_name)}}</h2>
                              </div>
                        <?php } ?>
                        <div class="blmContent">
                           <div class="d-flex manageFlex mt-3">
                              <div class="divOne3">
                                 <div class="imgContnt">
                                    @if(!empty($bloom_news_report->caption))
                                    <a href="{{$bloom_news_report->url}}">{{ucfirst($bloom_news_report->title)}}</a>{!! nl2br($bloom_news_report->caption) !!}
                                    @endif
                                 </div>
                              </div>
                           </div>
                     ...
                     @if(!in_array($bloom_news_report->category_id,$cdata_2))
                        @php 
                           $catId = $bloom_news_report->category_id;
                           $cdata_2[$catId][] = $catId; 
                        @endphp
                        {{ @App\Helpers\UtilitiesFour::getBloomAds($cdata_2,$catId) }}
                     @endif
               @endforeach         
            </div>
         @endif
               ...
               <div class="d-flex manageFlex">
                  <div class="divOne3 ">
                     <div class="imgContnt wldWideList py-3">
                        ...
                        {!! nl2br(@$bloomReport['weekly_stories']->caption) !!}
                     </div>
                  </div>
               </div>
            </div>
