...
var user_subscribe_data_saved_flag = '{{ Session::has("user_subscribe_data_saved_flag") }}';var user_plan_upgrade_data_saved_flag = '{{ Session::has("user_plan_upgrade_data_saved_flag") }}';var user_plan_created_data_saved_flag = '{{ Session::has("user_plan_created_data_saved_flag") }}';if(user_plan_upgrade_data_saved_flag!=""){	user_subscribe_data_saved_flag = '';	user_plan_created_data_saved_flag = '';}if(user_plan_created_data_saved_flag!=""){	user_subscribe_data_saved_flag = '';	user_plan_upgrade_data_saved_flag = '';}
