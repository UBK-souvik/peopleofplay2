                            ...
                            <tr id="row_{{@$collab->id}}">
                                ...
                                <td class="verticalalign text-left pl-0">
                                    <span class="table-edit">
                                        <a href="#" class="span-style1 my-0 edit-role-popup-class" data-user_role="{{@$collab->role}}" data-people_name="{{$str_user_name}}" data-user_name="{{$str_user_name}}" data-people_id="{{@$collab->people_id}}" data-user_image="{{ $collaborator_photos_folder }}{{ $collaborator_img_data }}" data-hidden_user_image="{{ $collaborator_img_data }}" data-collaboration_id="{{@$collab->id}}" >Edit</a>
                                    </span>
                                </td>
