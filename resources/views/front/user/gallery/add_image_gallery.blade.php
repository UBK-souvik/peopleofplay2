      ...
      @if(empty($int_gallery_id) && !empty($user_id))
         {{--
            <!-- <button type="button" class="btn edit-btn-style" data-toggle="modal" data-backdrop="static" data-keyboard="false"
               data-target="#ModalGalleryVideoForm{{ $int_gallery_id }}" onclick="open_add_GalleryModalView(this); return false;"> -->
         --}}
      <button type="button" class="btn edit-btn-style" onclick="open_add_GalleryModalView(this,'','{{$gallery_type}}'); return false;">
