      ...
      <div class="image-box text-center">
        <div class="image-box-text" id="videoPreviewIcon">
          <div class="popFeedIcon">
            <img src="{{ asset('front/images/feed/feed_videos.png') }}" class="img-fluid mb-1">
          </div>
...
<div class="popFeedTitle">
  <div class="form-group">
    <input id="VideoUrl" type="text" name="video_url" class="form-control" value="{{@$news_Feeds->video_url}}" placeholder="Video URL" onchange="getYoutubeThumbnailfeed(this);">
    <span class="errText" style="display:none;"></span>
  </div>
</div>
<div class="popFeedTitle">
  <div class="form-group">
    <input id="title" type="text" name="title" class="form-control" value="{{@$news_Feeds->title}}" placeholder="Title">
    <span class="errText" style="display:none;"></span>
  </div>
</div>
