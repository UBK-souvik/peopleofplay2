...
<html lang="en">
    <head>
        ...
        <title>{{ adminTransLang('admin_app_name') }} - @yield('title')</title>
        ...
        <link rel="stylesheet" href="{{ URL::to('backend/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css') }}">
		...
		<link rel="stylesheet" href="{{ URL::to('backend/css/backend_style_two.css') }}">
        <link rel="stylesheet" href="{{ URL::to('backend/css/backend_style_three.css') }}">
        <!-- Tel Input -->
        @include('includes.include_skills_css')
		...
		@if(!empty($is_chk_admin_blog_flag))
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <!-- bootstrap date-time picker -->
        <script src="{{ URL::to('backend/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js') }}"></script>
        ...
        <!-- Tel Input -->
        @include('includes.include_skills_js_scripts')
        <!-- Google Map -->
        ...
        <script src="{{ URL::to('backend/js/backend_library_one.js') }}"></script>
            ...
            $(document).on('click', 'a[data-toggle="modal"]', function (e) {
                ...
                $(target_element).find('.modal-content').html('<div class="modal-body">\
                        ...
                        <div class="col-md-12 center">\
                                <i class="fa fa-spinner fa-spin fa-lg blue"></i> {{ adminTransLang("please_wait_this_will_take_few_moments") }}..\
                            </div>\
                        </div>\
                    </div>\
                </div>');
