                    ...
                    <div class="box">
                        <div class="box-body" id="add-edit-user-main-box-body-div">
                            ...
                            <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="{{@$event_header->id}}">
                                @csrf
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body is-active">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control" name="h1_tag" placeholder="" value="{{@$event_header->h1_tag}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="h3_tag" placeholder="" value="{{@$event_header->h3_tag}}">
                                            </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="fun_fact1" class="col-sm-2 control-label">Button One Text</label>
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="button_text" placeholder="" value="{{@$event_header->button_text}}">
                                            </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="fun_fact1" class="col-sm-2 control-label">Button Two Text</label>
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="button_two_text" placeholder="" value="{{@$event_header->button_two_text}}">
                                            </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="fun_fact1" class="col-sm-2 control-label">Button Three Text</label>
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="button_three_text" placeholder="" value="{{@$event_header->button_three_text}}">
                                            </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="fun_fact1" class="col-sm-2 control-label">Button One Link</label>
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="button_one_link" placeholder="" value="{{@$event_header->button_one_link}}">
                                            </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="fun_fact1" class="col-sm-2 control-label">Button Two Link</label>
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="button_two_link" placeholder="" value="{{@$event_header->button_two_link}}">
                                            </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="fun_fact1" class="col-sm-2 control-label">Button Three Link</label>
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="button_three_link" placeholder="" value="{{@$event_header->button_three_link}}">
                                            </div>
                                         </div>
      ...
      $(document).on('click','#createBtn',function(e){
        ...
        // alert("ok");
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "{{ route('admin.eventheader.create') }}",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        // alert(data.msg);
                        window.location.replace('{{ route("admin.eventheader.index")}}');
