...
@section('content')
	...
	<!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <p>
                <a href="{{ route('admin.cast.category.create') }}" class="btn btn-success">Create</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("admin.cast.category.list") }}',
            columns : [
	            { "data": "name" },
                { "data": "description" },
                { "data": "status" },
        ...
        $('#navigation-table').on('click', '.delete_admins', function(e){
            ...
            if (r == false) {
             ...
             if($(this).attr('href') == 'javascript:void(0);') {
                 var r = confirm("{{ 'Cannot delete this category because it has been used Cast.' }}");
                  return false;
            }
