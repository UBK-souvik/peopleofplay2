...
@section('title') Create Description @endsection
  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.eventdescription.index') }}"> Event Description </a></li>
                                    ...
                                    <div class="accordion__body is-active">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="description_header" placeholder=""
                                             value="{{@$event_description->description_header}}">
                                            </div>
                                        </div>
                                         <div class="form-group">
      ...
      $(document).on('click','#createBtn',function(e){
        ...
        // alert("ok");
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "{{ route('admin.eventdescription.create') }}",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        // alert(data.msg);
                        window.location.replace('{{ route("admin.eventdescription.index")}}');
