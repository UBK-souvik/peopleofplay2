...
@section('title') Create Entertainments @endsection
  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.entertainment.index') }}"> All Entertainments </a></li>
            <li class="active">Create Entertainments</li>
        </ol>
    </section>
    ...
    jQuery(function($) {
      ...
      $(document).on('click','#createBtn',function(e){
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "{{ route('admin.entertainment.create') }}",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        window.location.replace('{{ route("admin.entertainment.index")}}');
