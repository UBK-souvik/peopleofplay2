...
@section('content')
	...
	<!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <p>
                <a href="{{ route('admin.sectionprofile.create') }}" class="btn btn-success">Create Profile</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("admin.sectionprofile.list") }}',
            columns : [
	            {
...

                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="{{ URL::to("admin/sectionprofile/update") }}/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a href="{{ URL::to("admin/sectionprofile/view") }}/'+row.id+'">\
                            <i class="fa fa-eye fa-fw"></i>\
                        </a>\
                        <a class="delete_admins" href="{{ URL::to("admin/sectionprofile/delete") }}/'+row.id+'">\
