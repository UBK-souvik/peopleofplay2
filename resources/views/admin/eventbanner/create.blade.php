  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.eventbanner.index') }}"> Create section six List </a></li>
                    ...
                    <div class="box">
                        <div class="box-body" id="add-edit-user-main-box-body-div">
                            ...
                            <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                                <input type="hidden" name="banner_id" value="{{@$event_banner->id}}">
                                @csrf
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body is-active">
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Banner Header <i class="has-error">*</i></label>
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control" name="bannerHeader" placeholder="" value="{{@$event_banner->banner_header}}">
                                            </div>
                                        </div>
      ...
      $(document).on('click','#createBtn',function(e){
        ...
        // alert("ok");
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "{{ route('admin.eventbanner.create') }}",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        // alert(data.msg);
                        window.location.replace('{{ route("admin.eventbanner.index")}}');
