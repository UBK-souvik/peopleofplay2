        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    <div class="center">
                        <h1>
                            <span class="red">{{ adminTransLang('company') }}.com</span>
                        </h1>
                        <h4 id="id-company-text" class="blue">&copy; {{ adminTransLang('admin_password_reset') }}</h4>
                    </div>
                                ...
                                <div class="widget-main">
                                    ...
                                    <form id="reset-form" method="post" action="{{ route('admin.password.reset') }}">
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
                                                <span class="block input-icon input-icon-right">
                                                    <input type="password" class="form-control" placeholder="{{ adminTransLang('new_password') }}" name="password" value="{{ Request::old('password') }}" />
                                                    <i class="ace-icon fa fa-key"></i>
                                                </span>
                                            </label>
                                            ...
                                            <label class="block clearfix">
                                                <span class="block input-icon input-icon-right">
                                                    <input type="password" class="form-control" placeholder="{{ adminTransLang('confirm_password') }}" name="password_confirmation" value="{{ Request::old('password_confirmation') }}" />
                                                    <i class="ace-icon fa fa-key"></i>
                                                </span>
                                            </label>
                                            ...
                                            <div class="clearfix">
                                                <button type="submit" id="reset-submit" class="width-50 pull-right btn btn-sm btn-danger">
                                                    <i class="ace-icon fa fa-key"></i>
                                                    <span class="bigger-110">{{ adminTransLang('reset_password') }}</span>
                                                </button>
                                            </div>
                                        </fieldset>
