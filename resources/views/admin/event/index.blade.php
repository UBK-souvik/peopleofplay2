...
@section('content')
	...
	<!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <p>
                <a href="{{ route('admin.event.create') }}" class="btn btn-success">Create Event</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
	...
	$(function() {
        $('#navigation-table').DataTable({
            ...
            columns : [
	            ...
	            {
                    mRender: function(data,type,row) {
                        return '<a href="{{URL::to("admin/award/") }}/'+row.id+'">Add Awards</a>'
                    }
                ...
                },
                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="{{ URL::to("admin/events/update") }}/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a href="{{ URL::to("admin/events/view") }}/'+row.id+'">\
                            <i class="fa fa-eye fa-fw"></i>\
                        </a>\
                        <a class="delete_admins" href="{{ URL::to("admin/events/delete") }}/'+row.id+'">\
