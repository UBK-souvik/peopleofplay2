  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.wiki.category.index') }}"> All Wiki Category </a></li>
    ...
    jQuery(function($) {
      $(document).on('click','#createBtn',function(e){
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "{{ route('admin.wiki.category.create') }}",
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        window.location.replace('{{ route("admin.wiki.category.index")}}');
