...
@section('title') Edit Free User @endsection
...
.intl-tel-input.allow-dropdown {width: 100%; }
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.free.users.index') }}">All Free Users</a></li>
                                ...
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body is-active">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-sm-6">
                                             <input type="email" readonly="" required class="form-control" name="email" placeholder="Email"  value="@if(!empty($user->email)){{$user->email}}@endif">
                                          </div>
                                       </div>
...
<script>
    $(document).ready(function(){
        ...
        $('body').on('click','#add-edit-user-main-box-body-div  #createBtn',function(e){
            ...
            $.ajax({
      			    url: "{{ route('admin.free_users.showedit', $user_id) }}",
                data: fd,
                processData: false,
                contentType: false,
                dataType: 'json',
                ...
                {
                    $('#add-edit-user-main-box-body-div  #createBtn').attr('disabled',false);                        
                    window.location.replace('{{ route("admin.free.users.index")}}');
