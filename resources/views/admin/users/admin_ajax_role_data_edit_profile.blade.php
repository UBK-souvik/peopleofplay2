...
<table class="table table-striped kproductTbl">
    <thead class="titlestyle table-dark">
        <tr>
            <!-- <th></th> -->
            <th class="text-left">{{ $role_type_data_new }} Role</th>
        ...
        @foreach ($role_data as $role)
            ...
            @endphp	  
                ...
                <tr id="{{$tr_row_role_div_id}}">
					...
					@if($int_role_type_id_data_new == 2)
                       <td class="verticalalign text-left pl-0 role_name_class_new">{{$arr_role_at_list[$int_role_at]}}</td>
                    @endif
					<td class="verticalalign text-left pl-0">
                    ...
                    <td class="verticalalign text-left pl-0">
                        <span class="table-edit">
                            <a href="#" class="span-style1 my-0 admin-edit-role-popup-class" data-role-name="{{$role->name}}" data-role-data="{{$role->role}}"  
                            ...
                            data-to_year_str="{{$to_year_str}}">Edit</a>
                        </span>
                    </td>
