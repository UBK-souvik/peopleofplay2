...
var admin_str_get_role_data_url_ajax = "/admin/user/profile/admin-get-user-role-data-ajax/{{$user_id}}/{{$str_random_time_stamp_new}}/{{$int_role_type_id_data_new}}";

$(document).ready(function(){
	
	    admin_show_user_roles_edit_profile_data();						if(document.getElementById('product_brand_hidden_id'))		{		   admin_get_company_people_list('Brand', '{{route("admin.user.role.search.brand_list")}}', 'product_brand_hidden_id', 'divProductMainDivIdAdminNew');			}				if(document.getElementById('product_company_hidden_id'))		{		   admin_get_company_people_list('Company', '{{route("admin.user.role.search.company")}}', 'product_company_hidden_id', 'divProductMainDivIdAdminNew');			}
		
		if(document.getElementById('admin_add_edit_profile_role_name_company_id'))
		{
		   admin_get_company_people_list('admin_add_edit_profile_role_name_company_id', '{{route("admin.user.role.search.company")}}', 'admin_add_edit_profile_role_company_hidden_id', 'adminAddRoleModalDivForm');	
		}
		
		if(document.getElementById('admin_add_edit_profile_role_name_people_id'))
		{
		   admin_get_company_people_list('admin_add_edit_profile_role_name_people_id', '{{route("admin.user.role.search.people")}}', 'admin_add_edit_profile_role_people_hidden_id', 'adminAddRoleModalDivForm');	
		}
		
		if(document.getElementById('admin_add_edit_profile_role_name_product_id'))
		{
		  admin_get_company_people_list('admin_add_edit_profile_role_name_product_id', '{{route("admin.user.role.search.product")}}', 'admin_add_edit_profile_role_product_hidden_id', 'adminAddRoleModalDivForm');
		}
		
		if(document.getElementById('collab_user_name'))
		{
		  admin_get_company_people_list('collab_user_name', '{{route("admin.user.role.search.people")}}', 'collab_user_id_hidden', 'AddEditCollabModalForm');
		}
		...
		$(document).on('click','.admin-show-add-role-modal-popup',function(e) {
			...
			@if(@$int_role_type_id_data_new == 2) 
