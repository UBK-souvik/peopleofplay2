...
@section('title') All Pedias @endsection
...
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="{{ route('admin.blog_pedia.create') }}" class="btn btn-success">Create Blog Pedia</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("admin.blog_pedia.list") }}',
            columns : [
                { "data": "title" },
	            { "data": "status" },
                {
                    ...
                    {
                        return '<a href="{{ URL::to("admin/blog_pedia/update") }}/'+row.id+'">\<i class="fa fa-eye fa-fw"></i></i>\</a>\<a class="delete_admins" href="{{ URL::to("admin/blog_pedia/delete") }}/'+row.id+'">\<i class="fa fa-trash fa-fw"></i>\</a>';
                    }, orderable: false
                }
	        ],
            order : [[0, 'desc']]
	...
	var blog_data_saved_flag = '{{ Session::has("blog_pedia_data_saved_flag") }}';
