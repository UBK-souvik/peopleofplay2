...
@section('title') Add Company Category @endsection

@section('content')

    <section class="content-header">
        <h1> @if(!empty(@$category->id)) Edit Company Category @else Create Company Category @endif </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> {{ adminTransLang('dashboard') }}</a></li>
            <li><a href="{{ route('admin.user_role.index') }}">All Company Categories</a></li>
            <li class="active">@if(!empty(@$category->id)) Edit Company Category @else Create Company Category @endif </li>
        </ol>
    </section>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-body" id="add-edit-user-main-box-body-div">
                            ...
                            <form class="form-horizontal" action="{{route('admin.company-category.create')}}" id="add-edit-user-main-box-body-form" method="post">
					            {{ csrf_field() }}
