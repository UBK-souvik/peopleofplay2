...
@section('content')
	...
	<!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <p>
                <a href="{{ route('admin.news_category.create') }}" class="btn btn-success">Create News Category</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("admin.news_category.list") }}',
            columns : [
	            { "data": "name" },
                { "data": "status" },
                {
                    ...
                    {
                        return '<a href="{{ URL::to("admin/news-category/update") }}/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a class="delete_admins" href="{{ URL::to("admin/news-category/delete") }}/'+row.id+'">\
