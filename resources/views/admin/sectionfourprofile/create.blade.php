  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.sectionfourprofile.index') }}">Section three Profile </a></li>
                    ...
                    <div class="box">
                        <div class="box-body" id="add-edit-user-main-box-body-div">
                            ...
                            <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                                <input type="hidden" name="profile_id" value="{{@$sectionfour_profile->id}}">
                                @csrf
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body is-active">
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control" name="profileHeader" placeholder="" value="{{@$sectionfour_profile->profileHeader}}">
                                            </div>
                                        </div> --}}
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Name <i class="has-error">*</i></label>
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control" name="profileName" placeholder="Enter Name" value="{{@$sectionfour_profile->profileName}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="profileUrl" placeholder="Enter Url"
                                             value="{{@$sectionfour_profile->profileUrl}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="profileSubtitle" placeholder="Enter Subtitle" value="{{@$sectionfour_profile->profileSubtitle}}">
                                            </div>
                                         </div>
                                        <div class="form-group">
      ...
      $(document).on('click','#createBtn',function(e){
        ...
        // alert("ok");
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "{{ route('admin.sectionfourprofile.create') }}",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        // alert(data.msg);
                        window.location.replace('{{ route("admin.sectionfourprofile.index")}}');
