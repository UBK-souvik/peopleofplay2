                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-body" id="add-edit-user-main-box-body-div">
                            <p class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
                            <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                                <input type="hidden" name="profile_id" value="{{@$event_profile->id}}">
                                @csrf
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body is-active">
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control" name="profileHeader" placeholder="" value="{{@$event_profile->profileHeader}}">
                                            </div>
                                        </div> --}}
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Name <i class="has-error">*</i></label>
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control" name="profileName" placeholder="Enter Name" value="{{@$event_profile->profileName}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="profileUrl" placeholder="Enter Url"
                                             value="{{@$event_profile->profileUrl}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="profileSubtitle" placeholder="Enter Subtitle" value="{{@$event_profile->profileSubtitle}}">
                                            </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="main_image" class="col-sm-2 control-label">Main Image <i class="has-error">*</i></label>
      ...
      $(document).on('click','#createBtn',function(e){
        ...
        // alert("ok");
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "{{ route('admin.eventyear.create') }}",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        // alert(data.msg);
                        window.location.replace('{{ route("admin.eventyear.index")}}');
