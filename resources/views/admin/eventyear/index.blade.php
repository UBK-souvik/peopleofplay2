...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("admin.eventyear.list") }}',
            columns : [
	            {
...

                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="{{ URL::to("admin/eventyear/update") }}/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a href="{{ URL::to("admin/eventyear/view") }}/'+row.id+'">\
                            <i class="fa fa-eye fa-fw"></i>\
                        </a>\
                        <a class="delete_admins" href="{{ URL::to("admin/eventyear/delete") }}/'+row.id+'">\
