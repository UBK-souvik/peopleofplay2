...
@section('content')
	...
	<!-- Content Header (Page header) -->
        <section class="content-header">
            <h1> All events Sub Category </h1>
            <ol class="breadcrumb">
                <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> {{ adminTransLang('dashboard') }}</a></li>
                <li class="active">All event Sub category</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <p>
                <a href="{{ route('admin.event_subcategory.create') }}" class="btn btn-success">Create event SubCategory</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("admin.event_subcategory.list") }}',
            columns : [
	            { "data": "name" },
                { "data": "status" },
                {
