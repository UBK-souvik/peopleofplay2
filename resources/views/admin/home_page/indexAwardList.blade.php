...
<section class="content">
   ...
   <p>
      <a href="{{url('admin/cms/home-award/create')}}" class="btn btn-success">Create Home Page Award</a>
   </p>
   <div class="row">
      <div class="col-md-12">
         <div class="box">
...
<script type="text/javascript">
   ...
   "pageLength": 50,
           processing: true,
           serverSide: true,
           ajax: '{{ route("admin.cms.home_page_award_list") }}',
           columns : [
   {
   ...
   { "data": "status" },                   
               {
                   "mRender": function (data, type, row) 
                   {
                       return '<a href="{{ route("admin.cms.home-award.update") }}/'+row.id+'">\<i class="fa fa-edit fa-fw"></i>\</a>\<a class="delete_admins" href="{{ route("admin.cms.home-award.delete") }}/'+row.id+'">\<i class="fa fa-trash fa-fw"></i>\</a>';
                   }, 
                   orderable: false
               }
           ],
