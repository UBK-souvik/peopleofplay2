...
@section('title') {{ adminTransLang('edit_navigation') }} @endsection

@section('content')

  <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1> {{ adminTransLang('edit_navigation') }}</h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> {{ adminTransLang('dashboard') }}</a></li>
            <li><a href="{{ route('admin.navigation.index') }}"> {{ adminTransLang('all_navigation') }} </a></li>
            <li class="active">{{ adminTransLang('edit_navigation') }}</li>
        </ol>
    </section>
                ...
                <div class="box-body">
                    ...
                    <form class="form-horizontal" id="update-form" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" name="name" placeholder="{{ adminTransLang('name') }}" value="{{ $navigation->name }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" name="en_name" placeholder="{{ adminTransLang('en_name') }}" value="{{ $navigation->en_name }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" name="action_path" placeholder="{{ adminTransLang('action_path') }}" value="{{ $navigation->action_path }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" name="icon" placeholder="{{ adminTransLang('icon') }}" value="{{ $navigation->icon }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" name="display_order" placeholder="{{ adminTransLang('display_order') }}" value="{{ $navigation->display_order }}">
                        </div>
                      </div>
