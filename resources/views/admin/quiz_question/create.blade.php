...
<section class="content-header">
   ...
   <ol class="breadcrumb">
      ...
      <li><a href="{{ route('admin.quiz.question.index') }}"> Quiz Question</a></li>
               ...
               <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-6">
                        <select class="form-control select2" name="quiz_id" >
                           ...
                           <option value="{{ $quiz_row->id }}" <?php if(@$question->quiz_id == @$quiz_row->id ){ echo "selected"; } ?> >{{ $quiz_row->title }}</option>
                           @endforeach
                        </select>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-sm-6">
                        ...
                        src="{{asset('uploads/images/question_quiz/'.$question->image)}}" @endif alt=""
                        class="imgHundred" >
                  ...
                  @endphp
                  @include('admin.includes.include_quiz_question_drop_down')
                  @endforeach  
                  <div class="form-group">
   ...
   jQuery(function($) {
     ...
     $(document).on('click','#createBtn',function(e){
       ...
       $.ajax({
         ...
         data: fd,
         dataType: 'json',
         url: '{{route("admin.quiz.question.create")}}',
         headers: {
       ...
       success: function (data)
       {
         ...
         if(data.status == 1)
         {
           ...
           window.location.replace('{{ route("admin.quiz.question.index")}}');
