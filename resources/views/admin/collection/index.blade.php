...
@section('title') All Collections @endsection
...
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="{{ route('admin.collection.create') }}" class="btn btn-success">Create Collection</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
        ...
        $('#navigation-table').DataTable({
            ...
            columns : [
	            ...
	            { "data": "status" },
                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="{{ URL::to("admin/collection/update") }}/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a class="delete_admins" href="{{ URL::to("admin/collection/delete") }}/'+row.id+'">\
	...
	var collection_data_saved_flag = '{{ Session::has("collection_data_saved_flag") }}';
