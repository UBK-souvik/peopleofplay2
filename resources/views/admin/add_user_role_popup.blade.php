       ...
       <div class="col-md-12">
            <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <select class="col-sm-3 dmy day rightMargin" name="add_edit_profile_role[from_day][]">
                    @if(!empty(@$from_day_str))
                        <option value="{{@$from_day_str}}" selected="">{{@$from_day_str}}</option> 
                    @endif
                  </select>
                  <select class="col-sm-3 dmy month rightMargin" name="add_edit_profile_role[from_month][]">
                    @if(!empty(@$from_month_str))
                        <option value="{{@$from_month_str}}" selected="">{{@$from_month_str}}</option>
                    @endif
                  </select>
                  <select class="col-sm-3 dmy year" name="add_edit_profile_role[from_year][]">
            ...
            <div class="col-md-4">
              ...
              <div class="form-group">
                ...
                <select class="col-sm-3 dmy day rightMargin" name="add_edit_profile_role[to_day][]">
                  @if(!empty(@$to_day_str))
                      <option value="{{@$to_day_str}}" selected="">{{@$to_day_str}}</option> 
                  @endif
                </select>
                <select class="col-sm-3 dmy month rightMargin" name="add_edit_profile_role[to_month][]">
                  @if(!empty(@$to_month_str))
                      <option value="{{@$to_month_str}}" selected="">{{@$to_month_str}}</option>
                  @endif
                </select>
                <select class="col-sm-3 dmy year" name="add_edit_profile_role[to_year][]">
