                      ...
                      <div class="accordion">
                          ...
                          <div class="accordion__body is-active">
                              <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                  @if(@$product->main_image)
                                      <img id="blah" src="{{imageBasePath($product->main_image)}}" class="twoFiftySeven">
                                  @else
                                   ...
                                   <select class="form-control select2" name="product[user_id]" id="user_id">
                                     ...
                                     @if(count($users) > 0)
                                        @foreach($users as $key => $user)
                                          <option value="{{$user->id}}" {{ (@$product->user_id  == $user->id ) ? 'selected' :''}}> {{$user->text}}</option>
                                        @endforeach
                                     @endif
                                   </select>
                                </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input id="ProductID" type="text" class="form-control" readonly name="product[product_id_number]" value="{{$product->product_id_number ?? generateRandomString()}}"placeholder="">
                                </div>
                              </div>
                             <div class="form-group">
                                <label for="email" class="col-sm-2 control-label">Product Name <i class="has-error">*</i></label>
                                <div class="col-sm-6">
                                    <input id="ProductName" type="text" value="{{ @$product->name }}" name="product[name]" class="form-control" placeholder="">
                                </div>
                             </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                 <textarea class="form-control" name="product[description]" rows="9" id="Productdescription" placeholder="">{{@$product->description}}</textarea>
                                </div>
                             </div>
                             <div class="form-group">
                                <label for="fun_fact1" class="col-sm-2 control-label">Fun Fact 1</label>
                                <div class="col-sm-6">
                                   <input required type="text" class="form-control" name="product[fun_fact1]" placeholder="Fun Fact 1" value="@if(!empty(@$product->fun_fact1)){{@$product->fun_fact1}}@endif">
                                </div>
                             </div>
                             <div class="form-group">
                                <label for="fun_fact2" class="col-sm-2 control-label">Fun Fact 2</label>
                                <div class="col-sm-6">
                                   <input required type="text" class="form-control" name="product[fun_fact2]" placeholder="Fun Fact 2" value="@if(!empty(@$product->fun_fact2)){{@$product->fun_fact2}}@endif">
                                </div>
                             </div>
                             <div class="form-group">
                                <label for="fun_fact3" class="col-sm-2 control-label">Fun Fact 3</label>
                                <div class="col-sm-6">
                                   <input required type="text" class="form-control" name="product[fun_fact3]" placeholder="Fun Fact 3" value="@if(!empty(@$product->fun_fact3)){{@$product->fun_fact3}}@endif">
                                </div>
                             </div>
							 <div class="form-group">
                                <label for="name" class="col-sm-2 control-label">Brand <!-- <i class="has-error">*</i> --> </label>
                                <div class="col-sm-6">
                                   <input id="Brand" type="text" name="product[brand]" value="@if(!empty($product->brand_list->name)){{@$product->brand_list->name}}@else{{@$product->brand}}@endif" class="form-control" placeholder="">
                              ...
                              <div class="form-group">
								...
								<div class="col-sm-6">
                                   <input id="Company" type="text" name="product[company]" value="{{@$str_company_user_name_new}}" class="form-control" placeholder="">
							   ...
							   <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input id="launched_date" type="date" name="product[launched_date]" value="{{@$product->launched_date}}" class="form-control" placeholder="">
                                </div>
                              </div>
                          </div>
                          ...
                          <div class="accordion__body">
                              <!-- <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input id="ProductPrice" type="number" name="product[price]" value="{{@$product->price}}" class="form-control" placeholder="">
                                </div>
                             </div> -->
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input id="Amazoncom" type="url" name="buy_from[0][amazon]" value="{{@$product->buyFrom->amazon ? $product->buyFrom->amazon : null}}" class="form-control" placeholder="Enter Url">
                                </div>
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input  type="hidden" name="buy_from[0][type]" value="1"> 
                                    <input id="ebay" type="url" name="buy_from[0][ebay]" value="{{@$product->buyFrom->ebay ? $product->buyFrom->ebay : null}}" class="form-control" placeholder="Enter Url">
                                </div>
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input  type="hidden" name="buy_from[0][type]" value="1"> 
                                    <input id="pop" type="url" name="buy_from[0][pop]" value="{{@$product->buyFrom->pop ? $product->buyFrom->pop : null}}" class="form-control" placeholder="Enter Url">
                                </div>
                             </div>
                          </div>
                          <div class="accordion__header">
                          ...
                          <div class="accordion__body">
                              @include("admin.product.view_collaborator_list")
                          </div>
                        ...
                        <?php /*
                          ...
                          <div class="accordion__body">
                              <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input type="url" id="ProposeOfficalLink1" name="official_links[1]" placeholder="URL here"class="form-control" value="{{@$product->officialLinks[0]->value}}">
                                </div>
                             </div>
                             <div class="form-group">
                                <label for="name" class="col-sm-2 control-label">URL</label>
                                <div class="col-sm-6">
                                   <input type="url" id="ProposeOfficalLink2" name="official_links[2]" placeholder="URL here"class="form-control" value="{{@$product->officialLinks[1]->value}}">
                                </div>
                             </div>
                          </div>
...
<?php /*
    ...
    @include("admin.product.add_edit_collaborator_popup")
@endsection
...
<script type="text/javascript">
  jQuery(document).on("change", ".get_sc" , function() {
    ...
    $.ajax({
       type:'GET',
       url:"{{ url('/admin/product/get_sub_category') }}",
       data:{
            "_token": "{{ csrf_token() }}",
            "id": id,
        },
...
<script type="text/javascript">
  jQuery(document).on("change", "#group_id" , function() {
    ...
    $.ajax({
       type:'GET',
       url:"{{ url('/admin/product/get_category_BYGroup') }}",
       data:{
            "_token": "{{ csrf_token() }}",
            "id": id,
        },
...
<script type="text/javascript">
  ...
  function deleteCollaboratorModal(collaborator_id){
    if (confirm('Are you sure?')) {
      $.ajax({
         type:'GET',
         url:"{{ url('/admin/product/collaborator/delete/') }}/"+collaborator_id,
         data:{
              "_token": "{{ csrf_token() }}",
          },
         success:function(data){
  ...
  $(document).on('click', '.AddEditCollabModalSave', function (e) {
      ...
      console.log(fd);
      $.ajax({
          url: "{{ route('admin.product.collaborator.AddEdit') }}",
          data: fd,
          processData: false,
          contentType: false,
          dataType: 'json',
          ...
          success: function (data) {
              ...
              // if ('{{@$product->id}}' != '' ) 
              // {
              //     window.location.replace("{{route('admin.product.update',@$product->id ?? null)}}");
              // }
              if(collaboration_id !=''){
