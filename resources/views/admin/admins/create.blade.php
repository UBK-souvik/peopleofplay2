...
@section('title') {{ adminTransLang('create_admin') }} @endsection

@section('content')

  <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1> {{ adminTransLang('create_admin') }}</h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> {{ adminTransLang('dashboard') }}</a></li>
            <li><a href="{{ route('admin.admins.index') }}"> {{ adminTransLang('all_admins') }} </a></li>
            <li class="active">{{ adminTransLang('create_admin') }}</li>
        </ol>
    </section>
                ...
                <div class="box-body">
                    ...
                    <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="email" class="form-control" name="email" placeholder="{{ adminTransLang('email') }}" value="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="password" class="col-sm-2 control-label">{{ adminTransLang('password') }} <i class="has-error">*</i></label>
                        <div class="col-sm-6">
                          <input type="password" class="form-control" name="password" placeholder="{{ adminTransLang('password') }}" value="">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" name="mobile" placeholder="{{ adminTransLang('mobile') }}" value="">
                        </div>
                      </div>
                      <div class="form-group">
