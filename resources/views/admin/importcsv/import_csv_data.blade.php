...
<style>
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.users.show.import.csv') }}">
{{ 'Import CSV' }}</a></li>
               ...
               <div class="col-md-12">
                  <div class="box">
                     <div class="box-body" id="import-csv-main-box-body-div">
                        ...
                        <form class="form-horizontal" id="import-csv-main-box-body-form" method="post" enctype="multipart/form-data" action ="{{ route('admin.users.save-import-users-data.csv')}}">
						{{ csrf_field() }}
...
$(document).ready(function(){
           ...
           /*$('body').on('click','#import-csv-main-box-body-div  #createBtn',function(e){
                ...
                $.ajax({
				    url: "{{ route('admin.users.save-import-users-data.csv')}}",  
                    data: fd,
                    processData: false,
                    contentType: false,
                    dataType: 'json',
