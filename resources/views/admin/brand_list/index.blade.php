...
@section('title') All Brands @endsection
...
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="{{ route('admin.brand_lists.create') }}" class="btn btn-success">Create Brand</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("admin.brand_list.list") }}',
            columns : [
                {
	            ...
	            //{ "data": "brand" },
                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="{{ URL::to("admin/brand_list/update") }}/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a href="{{ URL::to("admin/brand_list/view") }}/'+row.id+'">\
                                <i class="fa fa-eye fa-fw"></i>\
                            </a>\
                        <a class="delete_admins" href="{{ URL::to("admin/brand_list/delete") }}/'+row.id+'">\
	...
	var brand_list_data_saved_flag = '{{ Session::has("brand_list_data_saved_flag") }}';
