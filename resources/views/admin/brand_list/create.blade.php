...
Brand</h1>
        <ol class="breadcrumb">
           ...
           <li><a href="{{url('admin/brand-lists')}}">All Brands</a></li>
           <li class="active">
@if(!empty($brand_list->id))
 {{'Update'}}
@else
                      ...
                      <div class="accordion">
                          ...
                          <div class="accordion__body is-active">
                              <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                  @if(@$brand_list->main_image)
                                      <img id="blah" src="{{imageBasePath($brand_list->main_image)}}" class="twoFiftySeven">
                                  @else
                                      <img id="blah" src="{{url('front/new/images/10.png')}}" alt="Preview" class="twoFiftySeven">
                                  @endif
                                   ...
                                   <select class="form-control select2" name="brand_list[user_id]" id="user_id">
                                     ...
                                     @if(count($users) > 0)
                                        @foreach($users as $key => $user)
                                          <option value="{{$user->id}}" {{ (@$brand_list->user_id  == $user->id ) ? 'selected' :''}}> {{$user->text}}</option>
                                        @endforeach
                                     @endif
                                   </select>
                                </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input id="BrandID" type="text" class="form-control" readonly name="brand_list[brand_list_id_number]" value="{{$brand_list->brand_list_id_number ?? generateRandomString()}}"placeholder="">
                                </div>
                              </div>
                             <div class="form-group">
                                <label for="email" class="col-sm-2 control-label">Brand Name <i class="has-error">*</i></label>
                                <div class="col-sm-6">
                                    <input id="BrandListName" type="text" value="{{ @$brand_list->name }}" name="brand_list[name]" class="form-control" placeholder="">
                                </div>
                             </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                 <textarea class="form-control" name="brand_list[description]" rows="9" id="BrandListdescription" placeholder="">{{@$brand_list->description}}</textarea>
                                </div>
                             </div>
                             <div class="form-group">
                                <label for="fun_fact1" class="col-sm-2 control-label">Fun Fact 1</label>
                                <div class="col-sm-6">
                                   <input required type="text" class="form-control" name="brand_list[fun_fact1]" placeholder="Fun Fact 1" value="@if(!empty(@$brand_list->fun_fact1)){{@$brand_list->fun_fact1}}@endif">
                                </div>
                             </div>
                             <div class="form-group">
                                <label for="fun_fact2" class="col-sm-2 control-label">Fun Fact 2</label>
                                <div class="col-sm-6">
                                   <input required type="text" class="form-control" name="brand_list[fun_fact2]" placeholder="Fun Fact 2" value="@if(!empty(@$brand_list->fun_fact2)){{@$brand_list->fun_fact2}}@endif">
                                </div>
                             </div>
                             <div class="form-group">
                                <label for="fun_fact3" class="col-sm-2 control-label">Fun Fact 3</label>
                                <div class="col-sm-6">
                                   <input required type="text" class="form-control" name="brand_list[fun_fact3]" placeholder="Fun Fact 3" value="@if(!empty(@$brand_list->fun_fact3)){{@$brand_list->fun_fact3}}@endif">
                                </div>
                             </div>
							 ...
							 {{-- <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input id="Brand" type="text" name="brand_list[brand]" value="{{@$brand_list->brand}}" class="form-control" placeholder="">
                                </div>
							 </div> --}}
                              ...
                              <div class="form-group">
							   ...
							   <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input id="launched_date" type="date" name="brand_list[launched_date]" value="{{@$brand_list->launched_date}}" class="form-control" placeholder="">
                                </div>
                              </div>
                          </div>
                          ...
                          <div class="accordion__body">
                              <!-- <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input id="BrandListPrice" type="number" name="brand_list[price]" value="{{@$brand_list->price}}" class="form-control" placeholder="">
                                </div>
                             </div> -->
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input id="Amazoncom" type="url" name="buy_from[0][amazon]" value="{{@$brand_list->buyFrom->amazon ? $brand_list->buyFrom->amazon : null}}" class="form-control" placeholder="Enter Url">
                                </div>
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input  type="hidden" name="buy_from[0][type]" value="1"> 
                                    <input id="ebay" type="url" name="buy_from[0][ebay]" value="{{@$brand_list->buyFrom->ebay ? $brand_list->buyFrom->ebay : null}}" class="form-control" placeholder="Enter Url">
                                </div>
                             </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input  type="hidden" name="buy_from[0][type]" value="1"> 
                                    <input id="pop" type="url" name="buy_from[0][pop]" value="{{@$brand_list->buyFrom->pop ? $brand_list->buyFrom->pop : null}}" class="form-control" placeholder="Enter Url">
                                </div>
                             </div>
                          </div>
                        ...
                        <?php /*
                          ...
                          <div class="accordion__body">
                              <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <input type="url" id="ProposeOfficalLink1" name="official_links[1]" placeholder="URL here"class="form-control" value="{{@$brand_list->officialLinks[0]->value}}">
                                </div>
                             </div>
                             <div class="form-group">
                                <label for="name" class="col-sm-2 control-label">URL 2</label>
                                <div class="col-sm-6">
                                   <input type="url" id="ProposeOfficalLink2" name="official_links[2]" placeholder="URL here"class="form-control" value="{{@$brand_list->officialLinks[1]->value}}">
                                </div>
                             </div>
                          </div>
...
<script type="text/javascript">
  jQuery(document).on("change", ".get_sc" , function() {
    ...
    $.ajax({
       type:'GET',
       url:"{{ url('/admin/brand_list/get_sub_category') }}",
       data:{
            "_token": "{{ csrf_token() }}",
            "id": id,
        },
...
<script type="text/javascript">
  jQuery(document).on("change", "#group_id" , function() {
    ...
    $.ajax({
       type:'GET',
       url:"{{ url('/admin/brand_list/get_category_BYGroup') }}",
       data:{
            "_token": "{{ csrf_token() }}",
            "id": id,
        },
...
<script type="text/javascript">
  ...
  function deleteCollaboratorModal(collaborator_id){
    if (confirm('Are you sure?')) {
      $.ajax({
         type:'GET',
         url:"{{ url('/admin/brand_list/collaborator/delete/') }}/"+collaborator_id,
         data:{
              "_token": "{{ csrf_token() }}",
          },
         success:function(data){
  ...
  $(document).on('click', '.AddEditCollabModalSave', function (e) {
      ...
      var brand_list_id = "{{@$brand_list->id}}";
      var collaboration_id = $("#collaboration_id").val();
      console.log(fd);
      $.ajax({
          url: "{{ route('admin.brand_list.collaborator.AddEdit') }}",
          data: fd,
          processData: false,
          contentType: false,
          dataType: 'json',
          ...
          success: function (data) {
              ...
              // if ('{{@$brand_list->id}}' != '' ) 
              // {
              //     window.location.replace("{{route('admin.brand_list.update',@$brand_list->id ?? null)}}");
              // }
              if(collaboration_id !=''){
    ...
    jQuery(function($) {
      ...
      $(document).on('click','#createBtn',function(e){
            ...
            fd.append('brand_list[description]', ckeditor_description_new);
                ...
                // }
            $.ajax({
                url: "{{ route('admin.brand_lists.create') }}",
                processData: false,
                contentType: false,
                data: fd,
                processData: false,
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        window.location.replace('{{ route("admin.brand_lists.index")}}');
