...
// For multiple vedio upload


$(document).ready(function($){

// Click button to activate hidden file input
$('.fileuploadervedio-btn').on('click', function(){
$('.fileuploadervedio').click();
});

// Click above calls the open dialog box
// Once something is selected the change function will run
$('.fileuploadervedio').change(function(){
...
$('div').append('<video src="' + fileContent + '" width="320" height="240" controls></video>');
}
