...
class UserLive extends Model
{
     ...
     */
    protected $fillable = [
       'is_csv_upload', 'csv_key', 'profile_image', 'name', 'gender', 'email', 'hide_email', 'hide_telephone', 'secondary_email', 'dial_code', 'mobile', 'secondary_mobile', 'password', 'remember_token', 'status', 'created_by', 'is_mobile_verified', 'otp', 'otp_generated_at', 'created_at', 'updated_at', 'country_id', 'type_of_industry', 'type_of_user', 'role', 'first_name', 'last_name', 'acronym', 'user_id_number', 'description', 'username', 'postal_address', 'zip_code', 'city', 'state', 'state_business', 'zip_code_business', 'city_business', 'country_id_business', 'website', 'business_address', 'dob', 'dobday', 'dobmonth', 'dobyear', 'stripe_id', 'skills', 'services', 'phone_number', 'secondary_phone_number', 'slug', 'no_of_employees', 'company_category_id', 'newsletter', 'fun_fact1', 'fun_fact2', 'fun_fact3', 'badge_1', 'badge_2', 'badge_3', 'badge_4', 'badge_5', 'badge_1_caption', 'badge_2_caption', 'badge_3_caption', 'badge_4_caption', 'badge_5_caption', 'employees_list', 'company_to_product_to_role', 'user_profile_responses', 'gold', 'virtual_show_room', 'pronoun', 'home_page_slide_show_caption','is_verify_profile'
    ];
