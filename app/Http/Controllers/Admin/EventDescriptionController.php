...
// echo 111;exit;
    ...
    public function getCreate()
    {
		...
		return view('admin.eventdescription.create', compact('users'));
    }
    ...
    public function getUpdate($id)
    {
        ...
        $event_description  = EventDescription::findOrFail($id);
        // echo "<pre>";
        // print_r($event_description);exit;
        // $users = User::pluck('email', 'id');
        //$users = User::where('role', '!=', 1)->get();
		// $users = User::get_all_user_list_by_email_name();
        return view('admin.eventdescription.create', compact('event_description'));
    }
    ...
    public function getView($id)
    {
        ...
        //$users = User::pluck('email', 'id');
		// $users = User::get_all_user_list_by_email_name();
        return view('admin.eventdescription.view', compact('event_description'));
    }
