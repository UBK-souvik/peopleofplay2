...
class SectionFourProfileController extends Controller
{
    public function getIndex()
    {
// echo 111;exit;
        return view('admin.sectionfourprofile.index');
    }
    ...
    public function getList()
    {
        ...
        $sectionfour_profile = \App\Models\SectionFourProfile::select('*');
        // print_r($sectionfour_profile);exit;
        return \DataTables::of($sectionfour_profile)
    ...
    public function getCreate()
    {
		...
		return view('admin.sectionfourprofile.create', compact('users'));
    }

    public function postCreate(Request $request)
    {
        // echo 111;exit;
            $sectionfour_profile = new SectionFourProfile();
        ...
        try {
            ...
            if ($request->filled('profile_id')) {
                    $sectionfour_profile = SectionFourProfile::findOrFail($request->profile_id);
                }
                ...
                // Shubham Code For Image Compression Start //
                    ...
                    if($img->resize($image_comp_size[0], $image_comp_size[1], function ($constraint) {
                        ...
                        $constraint->aspectRatio();
                            ...
                            $sectionfour_profile->main_image = $filename;
                    }else{
            ...
            $sectionfour_profile->profileName = $request->profileName;
            $sectionfour_profile->profileSubtitle = $request->profileSubtitle;
            $sectionfour_profile->profileUrl = $request->profileUrl;

                // print_r ($sectionfour_profile);exit;
            $sectionfour_profile->save();
    ...
    public function getUpdate($id)
    {
        ...
        $sectionfour_profile  = SectionFourProfile::findOrFail($id);
        // echo "<pre>";
        // print_r($sectionfour_profile);exit;
        // $users = User::pluck('email', 'id');
        //$users = User::where('role', '!=', 1)->get();
		// $users = User::get_all_user_list_by_email_name();
        return view('admin.sectionfourprofile.create', compact('sectionfour_profile'));
    }
    ...
    public function getView($id)
    {
        ...
        //$users = User::pluck('email', 'id');
		// $users = User::get_all_user_list_by_email_name();
        return view('admin.sectionfourprofile.view', compact('sectionfour_profile'));
    }

    public function getDelete($id)
    {
        $sectionfour_profile  = SectionFourProfile::findOrFail($id)->delete();
        return response()->json([
            'status' => 1,
            'msg' => adminTransLang('request_processed_successfully'),
        ], 200);
