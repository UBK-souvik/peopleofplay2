...
class EventBannerController extends Controller
{
    ...
    {
// echo 111;exit;
        return view('admin.eventbanner.index');
    }
    ...
    public function getList()
    {
        ...
        $event_banner = \App\Models\EventBanner::select('*');
        // print_r($event_banner);exit;
        return \DataTables::of($event_banner)
    ...
    public function getCreate()
    {
		...
		return view('admin.eventbanner.create', compact('users'));
    }

    public function postCreate(Request $request)
    {
        // echo 111;exit;
            $event_banner = new EventBanner();
        ...
        try {
            ...
            if ($request->filled('banner_id')) {
                    $event_banner = EventBanner::findOrFail($request->banner_id);
                }
                ...
                // Shubham Code For Image Compression Start //
                    ...
                    if($img->resize($image_comp_size[0], $image_comp_size[1], function ($constraint) {
                        ...
                        $constraint->aspectRatio();
                            ...
                            $event_banner->main_image = $filename;
                    }else{
            ...
            $event_banner->banner_header = $request->bannerHeader;
    ...
    public function getUpdate($id)
    {
        ...
        $event_banner  = EventBanner::findOrFail($id);
        // echo "<pre>";
        // print_r($event_banner);exit;
        // $users = User::pluck('email', 'id');
        //$users = User::where('role', '!=', 1)->get();
		// $users = User::get_all_user_list_by_email_name();
        return view('admin.eventbanner.create', compact('event_banner'));
    }
    ...
    public function getView($id)
    {
        ...
        //$users = User::pluck('email', 'id');
		// $users = User::get_all_user_list_by_email_name();
        return view('admin.eventbanner.view', compact('event_banner'));
    }

    public function getDelete($id)
    {
        $event_banner  = EventBanner::findOrFail($id)->delete();
        return response()->json([
            'status' => 1,
            'msg' => adminTransLang('request_processed_successfully'),
        ], 200);
