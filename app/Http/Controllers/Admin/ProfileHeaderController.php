...
class ProfileHeaderController extends Controller
{
    ...
    {
// echo 111;exit;
        return view('admin.profileheader.index');
    }
    ...
    public function getList()
    {
        ...
        $profile_header = \App\Models\ProfileHeader::select('*');
        // print_r($profile_header);exit;
        return \DataTables::of($profile_header)
    ...
    public function getCreate()
    {
		...
		return view('admin.profileheader.create', compact('users'));
    }

    public function postCreate(Request $request)
    {
        // echo 111;exit;
            $profile_header = new ProfileHeader();
        ...
        try {
            ...
            if ($request->filled('header_id')) {
                    $profile_header = ProfileHeader::findOrFail($request->header_id);
                }

            $profile_header->profileHeader = $request->headerName;
    ...
    public function getUpdate($id)
    {
        ...
        $profile_header  = ProfileHeader::findOrFail($id);
        // echo "<pre>";
        // print_r($profile_header);exit;
        // $users = User::pluck('email', 'id');
        //$users = User::where('role', '!=', 1)->get();
		// $users = User::get_all_user_list_by_email_name();
        return view('admin.profileheader.create', compact('profile_header'));
    }
    ...
    public function getView($id)
    {
        ...
        //$users = User::pluck('email', 'id');
		// $users = User::get_all_user_list_by_email_name();
        return view('admin.profileheader.view', compact('profile_header'));
    }

    public function getDelete($id)
    {
        $profile_header  = ProfileHeader::findOrFail($id)->delete();
        return response()->json([
            'status' => 1,
            'msg' => adminTransLang('request_processed_successfully'),
        ], 200);
