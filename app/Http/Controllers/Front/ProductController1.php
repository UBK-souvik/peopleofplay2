...
class ProductController extends ModuleController
{
    ...
    public function getProductCreate()
    {
        ...
        return view('front.user.product.add', compact('category','slug', 'user'));
    }
    ...
    public function getUpdate($slug)
    {
        ...
        return view('front.user.product.add', compact('user', 'product', 'category','slug','collaborator_photos_folder'));
    }
