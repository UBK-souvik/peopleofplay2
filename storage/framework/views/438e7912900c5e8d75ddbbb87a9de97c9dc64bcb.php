...
<?php $__env->startSection('title'); ?> All Collections <?php $__env->stopSection(); ?>
...
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.collection.create')); ?>" class="btn btn-success">Create Collection</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.collection.list")); ?>',
            columns : [
                {
	            ...
	            { "data": "status" },
                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="<?php echo e(URL::to("admin/collection/update")); ?>/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a class="delete_admins" href="<?php echo e(URL::to("admin/collection/delete")); ?>/'+row.id+'">\
	...
	var collection_data_saved_flag = '<?php echo e(Session::has("collection_data_saved_flag")); ?>';

        $(document).ready(function(){
			
		if(collection_data_saved_flag!="")
		 {
