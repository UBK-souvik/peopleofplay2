<?php
$tr_row_role_div_id = 'trRoleDivId';
?>
<!--Table-->
<table class="table table-striped kproductTbl">
    <thead class="titlestyle table-dark">
        <tr>
            <!-- <th></th> -->
            <th class="text-left"><?php echo e($role_type_data_new); ?> Role</th>
    ...
    <tbody class="tbody_productlist">
        <?php $__currentLoopData = $role_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			...
			$tr_row_role_div_id = 'trRoleDivId'.$role->id;
			
            ?>	  

                <tr id="<?php echo e($tr_row_role_div_id); ?>">
					...
					<?php if($int_role_type_id_data_new == 2): ?>
                       <td class="verticalalign text-left pl-0 role_name_class_new"><?php echo e($arr_role_at_list[$int_role_at]); ?></td>
                    <?php endif; ?>
					<td class="verticalalign text-left pl-0">
                    ...
                    <td class="verticalalign text-left pl-0">
                        <span class="table-edit">
                            <a href="#" class="span-style1 my-0 admin-edit-role-popup-class" data-role-name="<?php echo e($role->name); ?>" data-role-data="<?php echo e($role->role); ?>"  
                            ...
                            data-to_year_str="<?php echo e($to_year_str); ?>">Edit</a>
                        </span>
                    </td>
