                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="leftSideImg text-center">
                              <img src="<?php echo e(asset('front/images/icons/girl.png')); ?>" alt="BannerImg" class="img-fluid">
                        </div>
                     </div>
                     <div class="col-md-6">
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-md-4 col-xl-3">
                        <div class="rightSideEventsContant">
                              <img src="<?php echo e(asset('front/images/icons/avtar-img')); ?>.png" alt="BannerImg" class="img-fluid">
                        </div>
                     </div>
                  </div>
            </div>
                  ...
                  <div class="row">
                     <div class="col-12">
                        <div class="jumbotron bannerJumbotron text-center">
                              ...
                              <a href="<?php echo e(route('front.sign-up')); ?>" class="btn aboutMiddleBannerBtn">JOIN POP</a>
                        </div>
                     </div>
                  </div>
            </div>
            ...
            <div class="aboutTestimonialSec">
                  <div class="aboutTestimonial">
                     <div class="testimonialSlider owl-carousel">
                        <?php for($i=0; $i<8; $i++){ ?>
                        <div class="item">
                              <a href="<?php echo e($slider['profile_url'][$i]); ?>">
                                 <div class="row">
                                    <div class="col-md-4 col-xl-3">
                                       <div class="rightSideEventsContant text-center position-relative">
                                             <img src="<?php echo e($slider['image'][$i]); ?>" alt="BannerImg" class="img-fluid">
                                             <div class="quoteImg position-absolute">
                                                <img src="<?php echo e(asset('front/images/icons/quote.png')); ?>" alt="quoteImg" class="img-fluid">
                                             </div>
                                       </div>
                                    </div>
                                    <div class="col-md-8 col-xl-9">
                                       <div class="leftSideEventsContant text-left py-4 text-dark">
                                             <p><?php echo e($slider['testi_text'][$i]); ?></p>
                                             <p><small><?php echo e($slider['name'][$i]); ?></small></p>
                                       </div>
                                    </div>
                                 </div>
                              </a>
