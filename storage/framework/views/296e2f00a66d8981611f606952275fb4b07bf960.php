...
<?php $__env->startSection('title'); ?> Create Entertainment Category <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

  <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1> Create Entertainment Category</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(adminTransLang('dashboard')); ?></a></li>
            <li><a href="<?php echo e(route('admin.entertainment.category.index')); ?>"> All Entertainment Category </a></li>
    ...
    jQuery(function($) {
      $(document).on('click','#createBtn',function(e){
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "<?php echo e(route('admin.entertainment.category.create')); ?>",
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        window.location.replace('<?php echo e(route("admin.entertainment.category.index")); ?>');
