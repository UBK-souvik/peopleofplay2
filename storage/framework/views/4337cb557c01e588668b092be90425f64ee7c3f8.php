<?php $__env->startSection('title'); ?> Description header <?php $__env->stopSection(); ?>
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.descriptionheader.list")); ?>',
            columns : [
	            { "data": "description_main_header" },
                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="<?php echo e(URL::to("admin/descriptionheader/update")); ?>/'+row.id+'">\
