                ...
                <div class="row sectionTop">
                    <div class="col-md-4 imgProfilePadding marginBottomTwenty lessMargin">
                        <div id="file-upload-form" class="uploader">
                            ...
                            <img id="blah" class="kfile_imageten img-fluid imgtwoeighty"  src="<?php echo e(@prodEventImageBasePath(@$event->main_image)); ?>" >
                       ...
                       <div class="row" id="First_Event">
                           <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    value="<?php echo e(isset($event) ? @$event->event_id_number : generateRandomString()); ?>"
                                        placeholder="">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="NameEvent" type="text" name="name" class="form-control" value="<?php echo e(@$event->name); ?>"
                                        placeholder="">
                                </div>
                            </div>
                       </div>
                       <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="NameEvent" type="text" name="website" class="form-control" value="<?php echo e(@$event->website); ?>"
                                        placeholder="">
                                </div>
                            </div>
                       </div>
                       <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-0">
                                    ...
                                    placeholder=""><?php echo e(@$event->description); ?></textarea>
                                </div>
                            </div>
                            <!--  -->
                        </div>
              ...
              <div class="row sectionBox">
                ...
                <div class="col-md-4 pl-0 inputPaddingLeft">
                  <div class="form-group">
                      ...
                      <input id="fun_fact1" type="text" name="fun_fact1" value="<?php echo e(@$event->fun_fact1); ?>"
                      class="form-control">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <input id="fun_fact2" type="text" value="<?php echo e(@$event->fun_fact2); ?>"
                ...
                <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <input id="fun_fact3" type="text"  class="form-control" value="<?php echo e(@$event->fun_fact3); ?>" name="fun_fact3" required="required" placeholder=""> <!-- name="EmailID" -->
                  </div>
                </div>
              </div>
            </div>
                            ...
                            <div class="col-md-3" >
                                <div class="form-group">
                                    ...
                                    <input type="url" id="<?php echo e($social); ?>" name="socials[<?php echo e($index); ?>]"
                                     value="<?php echo e($str_social_val); ?>" class="form-control social">
                                </div>
                            </div>
...
// ref-radio
    ...
    $(function ($) {
        ...
        $(document).on('click', '#eventSubmit', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('front.user.event.create')); ?>",
                data: fd,
                processData: false,
                contentType: false,
                dataType: 'json',
                ...
                success: function (data) {
                    ...
                    window.location.replace('<?php echo e(route("front.user.event.index")); ?>');
    ...
    $(document).on('click', '#awardSubmit', function (e) {
            ...
            // var fd = new FormData($('#award-form')[0]);
            // $.ajax({
            //     url: "<?php echo e(route('front.user.event.award.create')); ?>",
            //     data: fd,
            //     processData: false,
            //     contentType: false,
            //     dataType: 'json',
