      ...
      <div class="box-width1">
         <div class="TopHeaderSignIn mb-3 ">
            <ul class="nav justify-content-end">
               <li class="nav-item">
                  <a class="nav-link li-color" href="<?php echo e(route('front.home.site.search.data')); ?>">Advanced Search</a>
               </li>
               <li class="nav-item">
                  <?php if(!Auth::guard('users')->check()): ?>
                     <a class="nav-link li-color " href="<?php echo e($str_link_user_login); ?>">Sign In</a>
                  <?php else: ?>
                     <a class="nav-link li-color" href="<?php echo e($str_link_user_logout); ?>">Logout</a>
                  <?php endif; ?>
               </li>
            </ul>
         </div>
            ...
            <div class="HeaderNavBar d-flex justify-content-between">
               <div class="HeaderSeachBar">
                  ...
                  <nav class="navbar navbar-expand-lg navbar-light w-100">
                     <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('front/images/mainLogo.png')); ?>" class="PopLogo"></a>
                     ...
                     <ul class="nav">
                        <li class="nav-item">
                           <div class="dropdown">
                              <a class="nav-link li-color" href="<?php echo e(route('front.feeds_news.news-feeds')); ?>">News</a>
                           </div>
                        </li>
                        <li class="nav-item">
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                 <div class="childDropOne">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e($str_link_advance_search); ?>">Search & Browse</a>
                                    <?php if(!Auth::guard('users')->check()): ?>
                                       <a class="dropdown-item" href="<?php echo e($str_link_sign_up); ?>">Create a Profile</a>
                                    <?php endif; ?>
                        ...
                        <div class="dropdown">
                           ...
                           <div class="dropdown-menu">
                              <div class="childDropOne">
                                 <a class="dropdown-item" href="<?php echo e($str_link_wiki); ?>">Wiki - Articles & Videos</a>
                                 <a class="dropdown-item" href="<?php echo e(route('front.pages.blogs')); ?>">Blogs & Interviews</a>
                                 <a class="dropdown-item" href="<?php echo e($str_link_drop_menu_dictionary_word_of_day); ?>">Dictionary</a>
                                 <a class="dropdown-item" href="<?php echo e($str_link_drop_menu_rip); ?>">Rest in Peace - RIP</a>
                                 <a class="dropdown-item" href="<?php echo e($str_link_pop_cast); ?>">Popcasts</a>
                                 <a class="dropdown-item" href="<?php echo e($str_link_pop_entertainment); ?>">Entertainment</a>
                                 <a class="dropdown-item" target="_blank" href="<?php echo e($str_link_pop_2021_first_quarter); ?>">Conferences</a>
                                 
                                 <a class="dropdown-item" href="<?php echo e(url('service-providers')); ?>">Service Providers</a>
                              </div>
                           </div>
                        </div>
                        </li>
                        ...
                        <li class="nav-item">
                        <div class="dropdown">
                           <a class="nav-link li-color" href="<?php echo e(route('front.about')); ?>">About POP</a>
                        </div>
                        </li>
                     </ul>
                     </div>  
               ...
               <div class="topSearchBar">
                  <div class="w-100 SearchBar">
                     <form class="form-inline mt-0 my-lg-0 w-100 mobsearchbar" id="form-home-site-search-input-main-mobile"  method="post" action="<?php echo e(route('front.home.site.search.data')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="w-100">
                           <?php
                           $int_is_desk_top_search_flag_new = 0;
                           ?>
                           <?php echo $__env->make("front.includes.top_search_bar", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                     </form>
                  </div>
               </div>
               <?php if(!Auth::guard('users')->check()): ?>
                  <div class="topBtn">
                     <a class="btn" href="<?php echo e($str_link_sign_up); ?>">Join Us</a>
                  </div>
               <?php else: ?>
                  <div class="topProfileBar">
                     ...
                     <div class="dropdown text-center">
                        <a class="btn dropdown-toggle p-0 drpMenu" data-toggle="dropdown">
                           <div class="topProfileImg"><img src="<?php echo e(@imageBasePath(Auth::guard('users')->user()->profile_image)); ?>" class="img-fluid"></div> Me
                        </a>
                        <div class="dropdown-menu">
                           <div class="profileDrop">
                              <div class="dropdown ">
                                 ...
                                 <?php if(!empty($user_current_info->id)): ?>
                                    <div class="dropdown-menu DashboardProfileDroplistList">
                                       <a class="dropdown-item" href="<?php echo e($str_profile_view); ?>"><img src="<?php echo e(asset('front/images/user.png')); ?>" alt="image">View My Profile</a>

                                       <a class="dropdown-item" href="<?php echo e($str_profile_user_edit); ?>"><img src="<?php echo e(asset('front/images/edit-profile.png')); ?>" alt="image"> Edit My Profile</a>
                                       <a class="dropdown-item" href="<?php echo e($str_profile_change_plan); ?>"><img src="<?php echo e(asset('front/images/plan.png')); ?>" alt="image"> Change My Plan</a>
                                       <a class="dropdown-item" href="http://www4.chitag.com/phplist/index.php?p=subscribe" target="_blank"><img src="<?php echo e(asset('front/images/newsletter.png')); ?>" alt="image"> Manage Newsletter</a>
                                       <a class="dropdown-item" href="<?php echo e($str_profile_change_password); ?>"><img src="<?php echo e(asset('front/images/password.png')); ?>" alt="image">Change Password</a>
                                       <!--   <a class="dropdown-item" href="javascript:void(0);"><img src="<?php echo e(asset('front/images/delete-close.png')); ?>" alt="image"> Delete Profile</a> -->
                                       <a class="dropdown-item" href="<?php echo e($str_link_user_logout); ?>"><img src="<?php echo e(asset('front/images/logout.png')); ?>" alt="image"> Logout</a>
                                    </div>
                                 <?php endif; ?>
                              </div>
                           </div>
                           <div class="childDropOne">
                              ...
                              <?php if(!empty($user_current_info->id)): ?>
                                 <div class="dropdown-menu DashboardProfileDroplistList">
                                    <a class="dropdown-item" href="<?php echo e($str_profile_all_image_gallery); ?>"><img src="<?php echo e(asset('front/images/image.png')); ?>" alt="image"> Photo Gallery </a>
                                    <a class="dropdown-item" href="<?php echo e($str_profile_all_video_gallery); ?>"><img src="<?php echo e(asset('front/images/video.png')); ?>" alt="video"> Videos</a>
                                    <a class="dropdown-item" href="<?php if($showLock == 0){ ?><?php echo e($str_profile_blog_index); ?> <?php } else { ?> javascript:void(0); <?php } ?>"><img src="<?php echo e(asset('front/images/blog.png')); ?>" alt="blog"> Blogs <?php if($showLock ==1 ): ?> <i class="fa fa-lock" ml-1></i> <?php endif; ?> </a>
                                    <?php if(($int_type_of_user ==2) && ($role_type_id == 3)): ?>
                                    <a  class="dropdown-item" href="<?php echo e($str_profile_brand_index); ?>" 
                                    class="nav-linkdashboard"><i class="flaticon-product mr-3 fa-icon1dashboard"
                                    aria-hidden="true"></i> Brand</a>
                                    <?php endif; ?>
                                    <a style="display:none;" class="dropdown-item" href="<?php if($showLock == 0){ ?><?php echo e($str_profile_product_index); ?> <?php } else { ?> javascript:void(0); <?php } ?>"><img src="<?php echo e(asset('front/images/product1.png')); ?>" alt="product1"> Product Posts <?php if($showLock ==1 ): ?> <i class="fa fa-lock" ml-1></i> <?php endif; ?> </a>
                                    <a class="dropdown-item" href="<?php if($showLock == 0){ ?><?php echo e($str_profile_classified_index); ?> <?php } else { ?> javascript:void(0); <?php } ?>"><img src="<?php echo e(asset('front/images/classifieds.png')); ?>" alt="classifieds"> Classifieds <?php if($showLock ==1 ): ?> <i class="fa fa-lock" ml-1></i> <?php endif; ?> </a>
                                    <a class="dropdown-item" href="<?php if($showLock == 0){ ?><?php echo e($str_profile_all_media); ?> <?php } else { ?> javascript:void(0); <?php } ?>"><img src="<?php echo e(asset('front/images/media.png')); ?>" alt="media"> Media <?php if($showLock ==1 ): ?> <i class="fa fa-lock" ml-1></i> <?php endif; ?> </a>

                                    <a class="dropdown-item" href="<?php if($showLock == 0){ ?><?php echo e($str_profile_all_award); ?> <?php } else { ?> javascript:void(0); <?php } ?>"><img src="<?php echo e(asset('front/images/awardimg.png')); ?>" alt="media"> Awards <?php if($showLock ==1 ): ?> <i class="fa fa-lock" ml-1></i> <?php endif; ?> </a>
                                 </div>
                                 <?php endif; ?>
                                 </div>
                              <a class="dropdown-item" href="<?php echo e($str_link_user_watch_list); ?>">Favorites</a>
                           </div>
                           <div class="childDroptwo">
                           <a class="dropdown-item" href="<?php echo e($str_profile_product_index); ?>">My Products</a>
                           <a class="dropdown-item" href="<?php echo e($str_profile_change_plan); ?>">Change my plan</a>
                           <a class="dropdown-item" href="<?php echo e(route('front.user.manage-payment-subscription')); ?>">Manage payment</a>
                           <a class="dropdown-item" href="http://www4.chitag.com/phplist/index.php?p=subscribe" target="_blank">Manage Newsletter</a>
                           <a class="dropdown-item" href="<?php echo e($str_profile_change_password); ?>">Change password</a>
                           <a class="dropdown-item" href="<?php echo e($str_link_user_logout); ?>">Logout</a>
                           </div>
                        </div>
                     </div>
                     </div>
...
<?php echo $__env->make("front.auth.view_plan_popup", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>