...
<?php $__env->startSection('title'); ?> Featured News <?php $__env->stopSection(); ?>
...
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.news_feeds.featured_news.create')); ?>" class="btn btn-success">Create News Feeds</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.news_feeds.featured_news_feeds_list")); ?>',
            columns : [
                {
                ...
                },
                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="<?php echo e(URL::to("admin/news_feeds/featured_news/update")); ?>/'+row.id+'">\
