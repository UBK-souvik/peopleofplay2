  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(route('admin.quiz.index')); ?>"> Quiz</a></li>
                    ...
                    <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          ...
                          <span>
                          <input type="text" class="form-control" name="title" placeholder="Title" value="<?php echo e(@$question->title); ?>">
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          ...
                          <span>
                          <textarea class="form-control" name="description" placeholder="Description"><?php echo e(@$question->description); ?></textarea>
                          </span>
                        </div>
                      </div>
                      <div class="form-group">
                     ...
                     <div class="col-sm-6">
                        ...
                        src="<?php echo e(asset('uploads/images/quiz/'.$question->image)); ?>" <?php endif; ?> alt=""
                        class="imgHundred" >
    ...
    jQuery(function($) {
        ...
        $(document).on('click','#createBtn',function(e){
            ...
            $.ajax({
                ...
                data: fd,
                dataType: 'json',
                url: '<?php echo e(route("admin.quiz.create")); ?>',
  			        headers: {
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        window.location.replace('<?php echo e(route("admin.quiz.index")); ?>');
