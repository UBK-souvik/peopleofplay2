  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(route('admin.eventyear.index')); ?>"> Create Profile </a></li>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-body" id="add-edit-user-main-box-body-div">
                            <p class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
                            <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                                <input type="hidden" name="profile_id" value="<?php echo e(@$event_profile->id); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body is-active">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Name <i class="has-error">*</i></label>
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control" name="profileName" placeholder="Enter Name" value="<?php echo e(@$event_profile->profileName); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="profileUrl" placeholder="Enter Url"
                                             value="<?php echo e(@$event_profile->profileUrl); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="profileSubtitle" placeholder="Enter Subtitle" value="<?php echo e(@$event_profile->profileSubtitle); ?>">
                                            </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="main_image" class="col-sm-2 control-label">Main Image <i class="has-error">*</i></label>
      ...
      $(document).on('click','#createBtn',function(e){
        ...
        // alert("ok");
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "<?php echo e(route('admin.eventyear.create')); ?>",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        // alert(data.msg);
                        window.location.replace('<?php echo e(route("admin.eventyear.index")); ?>');
