...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.feeds-category.create')); ?>" class="btn btn-success">Create Feeds Categories</a>
            </p>
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
...
<script type="text/javascript">
    $(function() {
        $('#navigation-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.feeds-category.list")); ?>',
            columns : [
                ...
                { "data": "name" },
                {
                    ...
                    {
                        return '<a href="<?php echo e(URL::to("admin/feeds-category/update")); ?>/'+row.id+'">\<i class="fa fa-edit fa-fw"></i>\</a>\<a class="delete_admins" href="<?php echo e(URL::to("admin/feeds-category/delete")); ?>/'+row.id+'">\<i class="fa fa-trash fa-fw"></i>\</a>';
                    }, orderable: false
                }
            ],
            order : [[0, 'desc']]
