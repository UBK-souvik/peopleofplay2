...
<?php if(@$fun_fact1 !='' || @$fun_fact2 !='' || @$fun_fact3 !=''): ?>
   ...
   <div class="popFunFact">
      ...
      <div class="card-deck">
         ...
         <div class="bg-white pt-2">
           ...
           <?php endif; ?>
            <?php if(!empty(@$fun_fact2)): ?>
         <div class="card FunFactCard bg-white text-dark mr-md-0 col-md-4" style="border: 1px solid #28a745!important;">
            <div class="bg-white pt-2">
               <?php if(!empty(@$fun_fact2) && strlen(@$fun_fact2) >40): ?>
