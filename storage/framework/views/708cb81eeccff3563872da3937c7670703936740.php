...
<?php echo $__env->make("front.includes.view_role_type_popup", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
function chk_role_type_selected()		
{
	...
	window.location.href = "<?php echo e($base_url.'/plans'); ?>" + "/" + str_role_id_sel;
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="text-center mt-4">
          ...
          <a type="button" class="btn RedButton popupSignUpWidth" href="<?php echo e(route('front.sign-up')); ?>" >SIGN UP</a>
          <p class="mt-1 p-text">* Already a Member? <a class="span-style1" href="<?php echo e(route('front.login')); ?>">Log In</a></p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="text-center text-md-left container">
      ...
      <div class="row text-center text-md-left px-3 pt-3">
        ...
        <div class="col-md-12 col-lg-4 mx-auto mt-3 imagecenter text-md-center text-lg-left">
          ...
          <li class="border mr-1"><img src="<?php echo e(asset('front/new/images/footergoogle.png')); ?>"></li>
            <li class="border"><img src="<?php echo e(asset('front/new/images/footerapp.png')); ?>"></li>
          </ul>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-sm-6 col-md-3 col-lg-2 mt-3 h4footer">
          ...
          <ul>
			...
			<li><a href="<?php echo e(route('front.contact-us')); ?>" target="_blank">Contact us</a></li>
        ...
        <div class="col-sm-6 col-md-3 col-lg-2 mt-3 h4footer">
          ...
          <ul>
            ...
            <li><a href="<?php echo e(route('front.pop_blogs')); ?>" target="_blank">POP Interviews</a></li>
            <li><a href="<?php echo e($str_link_pop_play_shop); ?>" class="li-color">Shop</a></li>
            <li><a href="<?php echo e($str_link_pop_contact_us); ?>">Contact Us</a></li>
            <li><a href="<?php echo e($str_link_knowledge_base_faqs); ?>">FAQs</a></li>
            <li><a href="<?php echo e(route('front.TermsAndConditions')); ?>"> Terms & Conditions</a></li>
          </ul>
        </div>
        <hr class="w-100 clearfix d-sm-none">
        <div class="col-sm-6 col-md-3 col-lg-2 mt-3 h4footer">
...
<div class="container">
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Grid row -->
<input type="hidden" name="int_search_dd_val_hidden_new" id="int_search_dd_val_hidden_new" value="<?php if(!empty($int_search_dd_val_desk_new)): ?><?php echo e($int_search_dd_val_desk_new); ?><?php endif; ?>">
  </footer>
...
<?php echo $__env->make('front.includes.include_footer_js_script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>