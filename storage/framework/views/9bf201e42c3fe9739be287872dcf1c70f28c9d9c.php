...
<?php $__env->startSection('title'); ?> Create Office Hour <?php $__env->stopSection(); ?>
  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(route('admin.office-hour.index')); ?>"> All  Office Hour </a></li>
                ...
                <div class="box-body">
                    ...
                    <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="text" class="form-control" name="featured_image_url" placeholder="url" value="<?php echo e(@$data->featured_image_url); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-3">
                         <select class="form-control" name="type">
                           ...
                           <option <?php if(@$data->type ==1): ?> <?php echo e('selected'); ?> <?php endif; ?> value="1">Email</option>
                           <option <?php if(@$data->type ==2): ?> <?php echo e('selected'); ?> <?php endif; ?> value="2">URL</option>
                         </select>
                        </div>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" name="meeting_url" placeholder="Meeting" value="<?php echo e(@$data->meeting_url); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="url" class="col-sm-2 control-label">Website URL</label>
                        <div class="col-sm-6">
                          <input type="text" class="form-control" name="website_url" placeholder="Website" value="<?php echo e(@$data->website_url); ?>">
                        </div>
                      </div>
                      <div class="form-group">
    ...
    jQuery(function($) {
      ...
      $(document).on('click','#createBtn',function(e){
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "<?php echo e(route('admin.office-hour.create')); ?>",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        window.location.replace('<?php echo e(route("admin.office-hour.index")); ?>');
