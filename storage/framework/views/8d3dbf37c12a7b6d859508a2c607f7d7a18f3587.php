...
<?php $__env->startSection('title'); ?> All User Roles <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.user_role.create')); ?>" class="btn btn-success">Create User Role</a>
            </p>
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
...
<script type="text/javascript">
    $(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.user_role.list")); ?>',
            columns : [
                { "data": "id"},
                { "data": "role_name" },
                {
                    ...
                    {
                        return '<a href="<?php echo e(URL::to("admin/user_role/update")); ?>/'+row.id+'">\<i class="fa fa-edit fa-fw"></i>\</a>\<a class="delete_admins" href="<?php echo e(URL::to("admin/user_role/delete")); ?>/'+row.id+'">\<i class="fa fa-trash fa-fw"></i>\</a>';
                    }, orderable: false
                }
            ],
            order : [[0, 'desc']]
