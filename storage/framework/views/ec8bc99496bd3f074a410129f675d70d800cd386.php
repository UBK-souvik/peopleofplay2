...
str_del_people_company_msg =  "<?php echo e(adminTransLang('people_company_are_you_sure_to_delete_one')); ?>";
str_del_people_company_msg = str_del_people_company_msg + "<?php echo e(adminTransLang('people_company_are_you_sure_to_delete_two')); ?>";
        $(function() {
