  ...
  <div class="col-ting my-4">
    <div class="control-group file-upload cropie-demo" id="file-upload1">
      <div class="image-box text-center"  >
        <div class="image-box-text <?php if(!empty(@$feeds->image)): ?><?php echo e('edit_image_preview'); ?><?php endif; ?>">
        ...
        <?php if(!empty(@$feeds->image)): ?>
          <img src="<?php echo e(asset('uploads/images/feed/'.@$feeds->image)); ?>" alt="" class="img-fluid uploadimg viewImagePreview editImagePreview">
        <?php else: ?>
...
<div class="form-group text-center <?php if(empty(@$feeds->image)): ?><?php echo e('edit_image_preview'); ?><?php endif; ?> ">
...
<div class="popFeedLink">
  <div class="form-group">
    <input id="link" type="text" name="link" class="form-control" value="<?php echo e(@$feeds->url); ?>" placeholder="Link" oninput="getOgProperty(this);">
    <span class="errText" style="display:none;"></span>
  </div>
</div>
<div class="popFeedTitle">
  <div class="form-group">
    <input id="Title" type="text" name="title" class="form-control" placeholder="Title" value="<?php echo e(@$feeds->title); ?>">
    <span class="errText" style="display:none;"></span>
  </div>
</div>
...
<script type="text/javascript">
  ...
  function crop_upload_image(e){
    ...
    $uploadCrop.croppie('result', {
      ...
      $.ajax({
        url: "<?php echo e(route('front.feed.croppie-image-post')); ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
