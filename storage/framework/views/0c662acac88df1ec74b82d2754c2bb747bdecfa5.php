...
<script type="text/javascript">
	$(function() {
        $('#settings-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.feed_reports.list")); ?>',
            scrollX: 200,
            scroller: {
    ...
    function reportView(e,id){
        $.ajax({
            url: "<?php echo e(route('admin.feed_reports.report_view')); ?>",
            data: {id:id},
            dataType: 'json',
            type: 'GET',
    ...
    function deleteReportedFeed(e,id){
        $.ajax({
            url: "<?php echo e(route('admin.feed_reports.delete_report_feed')); ?>",
            data: {id:id},
            dataType: 'json',
            type: 'GET',
            success: function (data) {
