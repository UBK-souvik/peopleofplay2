                      ...
                      <tbody class="tbody_productlist" id='table_append'>
                        ...
                        <?php $__currentLoopData = @$product->collaborators ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $collab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						  ...
						  ?>
                            ...
                            <tr id="row_<?php echo e(@$collab->id); ?>">
                                ...
                                <td class="verticalalign text-left pl-0">
                                    ...
                                    <span class="table-edit">
                                        ...
                                        <a href="#" class="span-style1 my-0" data-user_role="<?php echo e(@$collab->role); ?>" data-people_name="<?php echo e($str_user_name); ?>" data-user_name="<?php echo e($str_user_name); ?>" data-people_id="<?php echo e(@$collab->people_id); ?>" data-user_image="<?php echo e($collaborator_photos_folder); ?><?php echo e($collaborator_img_data); ?>" data-hidden_user_image="<?php echo e($collaborator_img_data); ?>" data-collaboration_id="<?php echo e(@$collab->id); ?>" onclick="editCollaboratorModal('<?php echo e(@$collab->id); ?>'); return false;">Edit</a>
