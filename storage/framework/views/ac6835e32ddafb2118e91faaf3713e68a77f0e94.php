...
<html>
	...
	<body style="">
		  ...
		  <div class="container pt-5" style="background-color: #fff;position: relative;min-height: 300px;margin: 0% 20% 0% 20%;">
		    ...
		    <hr>
		    <p class="mb-1"><strong>Name:</strong> <?php echo e($contact_name); ?></p>
		    <hr>
		    <p class="mb-1"><strong>Email:</strong> <?php echo e($contact_email); ?></p>
			<hr>
		    <p class="mb-1"><strong>Mobile:</strong> <?php echo e($contact_mobile); ?></p>
			<hr>
		    <p class="mb-1"><strong>Subject:</strong> <?php echo e($contact_subject); ?></p>
			<hr>
		    <p class="mb-1"><strong>Message:</strong> <?php echo e($contact_message); ?></p>
