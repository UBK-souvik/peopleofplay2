...
<?php $__env->startSection('title'); ?> All Entertainment Category <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
	...
	<!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.entertainment.category.create')); ?>" class="btn btn-success">Create</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.entertainment.category.list")); ?>',
            columns : [
	            { "data": "name" },
                { "data": "description" },
                { "data": "status" },
        ...
        $('#navigation-table').on('click', '.delete_admins', function(e){
            ...
            if (r == false) {
             ...
             if($(this).attr('href') == 'javascript:void(0);') {
                 var r = confirm("<?php echo e('Cannot delete this category because it has been used Wiki.'); ?>");
                  return false;
            }
