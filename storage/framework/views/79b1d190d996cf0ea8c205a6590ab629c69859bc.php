      ...
      <div class="row sectionBox">
        ...
        <div class="col-md-4 px-0 px-md-2">
          <div class="form-group">
              ...
              <input id="fun_fact1" type="text" name="<?php echo e($str_txt_fun_fact_1_new); ?>" value="<?php echo e(@$str_get_fun_fact_1_new); ?>"
              class="form-control">
          </div>
        </div>
        <div class="col-md-4 px-0 px-md-2">
          <div class="form-group">
              ...
              <input id="fun_fact2" type="text" value="<?php echo e(@$str_get_fun_fact_2_new); ?>"
              name="<?php echo e($str_txt_fun_fact_2_new); ?>" required="required" class="form-control" placeholder=""> <!-- name="EmailID" -->
          </div> 
        </div>
        <div class="col-md-4 px-0 px-md-2">
          <div class="form-group">
              <label for="fun_fact3">Fun Fact 3</label></span>
              <input id="fun_fact3" type="text"  class="form-control" value="<?php echo e(@$str_get_fun_fact_3_new); ?>" 
			  name="<?php echo e($str_txt_fun_fact_3_new); ?>" required="required" placeholder=""> <!-- name="EmailID" -->
          </div>
        </div>
      </div>
    </div>