          ...
          <div class="col-md-12 " >
            <div class="row sectionTop">
              <div class="col-sm-10 px-0">
                ...
                <div class="mb-0">
                  ...
                  <p class="mb-0 span-text-grey" ><small class="span-text-grey ml-0 blogDate"><?php if(!empty($blog['blog_category_name'])): ?><?php echo e(@$blog['blog_category_name']); ?><?php endif; ?></small> 
                  </p>
                </div>
              </div>
            ...
            <!-- <p><small class="span-style DeskMobAlign ml-0 blogDate"><?php if(!empty($blog_category_name)): ?><?php echo e(@$blog_category_name); ?><?php endif; ?> | <?php echo e(@App\Helpers\Utilities::getDateFormat($blog->created_at)); ?></small> </p> -->
              ...
              <div class="mt-2 w-100">
                <img src="<?php echo e(@$blog['featured_image']); ?>" class="imgDetailBlog">
              </div>          
