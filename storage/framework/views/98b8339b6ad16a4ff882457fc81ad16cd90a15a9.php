...
<?php $__env->startSection('title'); ?> All Cast <?php $__env->stopSection(); ?>
...
<section class="content">
  ...
  <p>
    <a href="<?php echo e(route('admin.cast.create')); ?>" class="btn btn-success">Create</a>
  </p>
  <div class="row">
    <div class="col-md-12">
      <div class="box">
...
<script type="text/javascript">
    ...
    $('#navigation-table').DataTable({
     ...
     processing: true,
     serverSide: true,
     ajax: '<?php echo e(route("admin.cast.list")); ?>',
     columns : [
     {
     ...
     { "data": "status" },
     {
      "mRender": function (data, type, row)
      {
        return '<a href="<?php echo e(URL::to("admin/cast/view")); ?>/'+row.id+'">\
        <i class="fa fa-eye fa-fw"></i>\
        </a>\
        <a href="<?php echo e(URL::to("admin/cast/update")); ?>/'+row.id+'">\
        <i class="fa fa-edit fa-fw"></i>\
        </a>\
        <a class="delete_admins" href="<?php echo e(URL::to("admin/cast/delete")); ?>/'+row.id+'">\
