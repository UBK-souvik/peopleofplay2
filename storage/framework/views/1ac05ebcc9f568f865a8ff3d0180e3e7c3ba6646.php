              ...
              <div class="PeoplePlaySignIn text-center py-2">
                ...
                <form method="POST" class="formStyle mb-5 mt-2" id="loginForm" onsubmit="submit_login_form_new(); return false;">
                    ...
                    <div class="text-center my-2">
					  <label class="form-check-label ForgetPwd text-secondary">Not a Member? <a href="<?php echo e(url('sign-up')); ?>" class="textPurple" >Sign Up</a> and <a class="textPurple" href="<?php echo e(route('front.forgot_password')); ?>">Forgot Password?</a>
					  </label>
                    </div>
                </form>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body Registration">
        <form>
               <button formaction="<?php echo e(route('front.register')); ?>?type=standard" type="submit" class="btn btn-secondary btn-lg btn-block btnLoginfree mr-2">Free Registration</button>
                <button formaction="<?php echo e(route('front.register')); ?>?type=paid" type="submit" class="btn btn-secondary btn-lg btn-block btnLoginfree">Paid Registration</button>
         </form>
      </div>
    </div>
  </div>
   ...
   //$(function($) {
            ...
            //$(document).on('click','#btnLogin',function(e){
              ...
              function submit_login_form_new() 
              {
                ...
                $.ajax({
                    url: "<?php echo e(route('front.login')); ?>",
                    data: fd,
                    processData: false,
                    contentType: false,
                    dataType: 'json',
