...
<?php $__env->startSection('title'); ?> All 3 Truths & a Lie <?php $__env->stopSection(); ?>
	...
	<!-- Content Header (Page header) -->
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Quiz Question</li>
            </ol>
        </section>
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.quiz.question.create')); ?>" class="btn btn-success">Create Quiz Question</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
			ajax: '<?php echo e(route("admin.quiz.question.list")); ?>',
            columns : [
	            ...
	            { "data": "status" },
                {
                    ...
                    {
						return '<a href="<?php echo e(URL::to("admin/quiz-question/update")); ?>/'+row.id+'">\<i class="fa fa-edit fa-fw"></i>\</a>\<a class="delete_admins" href="<?php echo e(URL::to("admin/quiz-question/delete")); ?>/'+row.id+'">\<i class="fa fa-trash fa-fw"></i>\</a>';
                    }, orderable: false
                }
	        ],
            order : [[0, 'desc']]
	...
	var question_data_saved_flag = '<?php echo e(Session::has("question_data_saved_flag")); ?>';
