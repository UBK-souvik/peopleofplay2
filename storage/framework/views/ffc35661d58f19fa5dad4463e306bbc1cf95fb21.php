...
<?php $__env->startSection('title'); ?> Create Entertainments <?php $__env->stopSection(); ?>
    ...
    jQuery(function($) {
      ...
      $(document).on('click','#createBtn',function(e){
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "<?php echo e(route('admin.entertainment.create')); ?>",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        window.location.replace('<?php echo e(route("admin.entertainment.index")); ?>');
