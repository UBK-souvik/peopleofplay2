...
<?php $__env->startSection('title'); ?> All Pedias <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

	<!-- Content Header (Page header) -->
        <section class="content-header">
            <h1> All Blog Pedias </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(adminTransLang('dashboard')); ?></a></li>
                <li class="active">All Blog Pedias</li>
            </ol>
        </section>
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.blog_pedia.create')); ?>" class="btn btn-success">Create Blog Pedia</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.blog_pedia.list")); ?>',
            columns : [
                { "data": "title" },
	            { "data": "status" },
                {
                    ...
                    {
                        return '<a href="<?php echo e(URL::to("admin/blog_pedia/update")); ?>/'+row.id+'">\<i class="fa fa-eye fa-fw"></i></i>\</a>\<a class="delete_admins" href="<?php echo e(URL::to("admin/blog_pedia/delete")); ?>/'+row.id+'">\<i class="fa fa-trash fa-fw"></i>\</a>';
                    }, orderable: false
                }
	        ],
            order : [[0, 'desc']]
	...
	var blog_data_saved_flag = '<?php echo e(Session::has("blog_pedia_data_saved_flag")); ?>';
