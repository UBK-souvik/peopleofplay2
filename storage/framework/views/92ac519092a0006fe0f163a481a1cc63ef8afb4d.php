...
<?php if(empty($str_checkPaidUserAuthentication_two)): ?>
      ...
      <div class="right-column k_sidebar right-colom-sidebar">
         <div class="RightSidebarAllPage">
            ...
            if(Request::segment(1) == 'user' && Request::segment(2) == 'product' && Request::segment(3) == 'update' ) {
             ...
             if(Request::segment(1) == 'user' && Request::segment(2) == 'classified' && Request::segment(3) == 'create') {
              ...
              if(Request::segment(1) == 'user' && Request::segment(2) == 'blog' && (Request::segment(3) == 'create' || Request::segment(3) == 'preview_detail' || Request::segment(3) == 'pre_view_detail')) {
               $homeSidebarShow = 0;
            }
            ...
            if(Request::segment(1) == 'user' && Request::segment(2) == 'classified' &&   Request::segment(3) == 'update' )
             ...
             if(Request::segment(1) == 'user' && Request::segment(2) == 'event' &&  Request::segment(3) == 'award' && (Request::segment(4) == 'create' || Request::segment(4) == 'update'))
             {
                $homeSidebarShow = 0;  
             }  

           if(Request::segment(1) == 'user' && Request::segment(2) == 'company')
         {
            $homeSidebarShow = 0;  
         } 
         ...
         if(Request::segment(1) == 'wiki' || Request::segment(1) == 'rest-in-play' || Request::segment(1) == 'popcast' || Request::segment(1) == 'entertainment'|| Request::segment(1) == 'featured-article' || Request::segment(1) == 'feeds' || Request::segment(1) == 'feed' || Request::segment(1) == 'news-feeds' || Request::segment(1) == 'news_feed' || Request::segment(1) == 'about')
         {
            $homeSidebarShow = 0;  
         }

             ?>
            <?php if($homeSidebarShow == 1): ?>
