...
<?php $__env->startSection('title'); ?> All Profile Type <?php $__env->stopSection(); ?>
    ...
    <script type="text/javascript">
        $(function() {
            $('#users-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route("admin.profile_type.list")); ?>',
                columns : [
                    { "data": "name" },
                    { "data": "email" },
                    { "data": "type_of_user" },
                    {
                        ...
                        {
                            return '<a href="<?php echo e(route("admin.profile_type.edit")); ?>/'+row.id+'">\<i class="fa fa-edit fa-fw"></i>\</a>';
                        }, 
                        orderable: false
                    }
                ],
