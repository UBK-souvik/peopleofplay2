...
<?php $__env->startSection('title'); ?> <?php echo e(adminTransLang('all_companies')); ?> <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <section class="content-header">
        <h1> <?php echo e(adminTransLang('all_companies')); ?> </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(adminTransLang('dashboard')); ?></a></li>
            <li class="active"><?php echo e(adminTransLang('all_companies')); ?></li>
        </ol>
    </section>
    ...
    <script type="text/javascript">
        $(function() {
            $('#users-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route("admin.companies.list")); ?>',
                columns : [
                    { "data": "name" },
                    { "data": "email" },
                    {
            ...
            // <a href="<?php echo e(URL::to("admin/users/reset-password")); ?>/'+row.id+'" class="danger" >\
