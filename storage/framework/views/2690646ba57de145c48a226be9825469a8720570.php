  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(route('admin.sectionfourprofile.index')); ?>">Section three Profile </a></li>
                    ...
                    <div class="box">
                        <div class="box-body" id="add-edit-user-main-box-body-div">
                            ...
                            <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                                <input type="hidden" name="profile_id" value="<?php echo e(@$section_profile->id); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body is-active">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control" name="profileName" placeholder="Enter Name" value="<?php echo e(@$section_profile->profileName); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="profileUrl" placeholder="Enter Url"
                                             value="<?php echo e(@$section_profile->profileUrl); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="profileSubtitle" placeholder="Enter Subtitle" value="<?php echo e(@$section_profile->profileSubtitle); ?>">
                                            </div>
                                         </div>
                                        <div class="form-group">
      ...
      $(document).on('click','#createBtn',function(e){
        ...
        // alert("ok");
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "<?php echo e(route('admin.sectionfourprofile.create')); ?>",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        // alert(data.msg);
                        window.location.replace('<?php echo e(route("admin.sectionfourprofile.index")); ?>');
