                            ...
                            <div class="border rounded  p-3 px-2">
                              <div class="row  mx-0">
                                <div class="col-md-10 col-10 pl-0">
                                  ...
                                  <p class="text-left fontThirteen mb-1"><?php if(!empty($subscription->plan->name)): ?><?php echo e(@$subscription->plan->name); ?><?php endif; ?></p>
                                  <p class="text-secondary fontThirteen mb-2">Active till: <?php if(!empty($subscription->ends_at)): ?><?php echo e(@App\Helpers\Utilities::getDateFormat($subscription->ends_at)); ?><?php endif; ?></p>
                                </div>
                                <div class="col-md-2 col-2 pr-0">
                                  <div class="text-right">
                                    <!-- <i class="fa fa-address-book-o fontTwenty photo_icon"></i> -->
                                    <img src="<?php echo e(asset('front/images/Plan.svg')); ?>">
                                  </div>
                                </div>
                                <div class="w-100">
                                  <hr class="mt-0 mb-2">
                                  <a href="<?php echo e($str_profile_change_plan); ?>" class="textPurple fontThirteen">Change Plan</a>&nbsp;&nbsp;<?php if(!empty($subscription->status) && $subscription->status ==4): ?><?php echo e('Plan cancelled'); ?><?php else: ?> <a href="javascript:void(0);" class="textPurple fontThirteen" id="cancel-subscription-new"> Cancel Plan </a> <?php endif; ?>
                                </div>
                              </div>
                            </div>
                           </div>
                            ...
                            <div class="border rounded  p-3 px-2">
                              <div class="row  mx-0">
                                <div class="col-md-10 col-10 pl-0">
                                  ...
                                  <?php echo $__env->make('front.profile.view_credit_card_info', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                                <div class="col-md-2 col-2 pr-0">
                                  <div class="text-right">
                                    <!-- <i class="fa fa-address-book-o fontTwenty photo_icon"></i> -->
                                    <img src="<?php echo e(asset('front/images/CreditCard.svg')); ?>">
                                  </div>
                                </div>
                                <div class="w-100">
                                  <hr class="mt-0 mb-2">
                                  <a href="javascript:void(0);" id="update_card" class="textPurple fontThirteen">Edit Info</a>                                
							                    	<?php echo $__env->make('front.profile.view_update_credit_card_info', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
								             </div>
                              </div>
                            </div>
                           </div>
                            ...
                            <div class="border rounded  p-3 px-2">
                              <div class="row  mx-0">
                                <div class="col-md-10 col-10 pl-0">
                                  ...
                                  <p class="text-left fontThirteen mb-1"><?php echo e($str_user_name); ?></p>
                                  <p class="text-secondary fontThirteen mb-2"><?php echo e(@$user_current_info->email); ?></p>
                                </div>
                                <div class="col-md-2 col-2 pr-0 pl-1">
                                  <div class="text-right">
                                    <!-- <i class="fa fa-address-book-o fontTwenty photo_icon"></i> -->
                                    <img width="50px" height="50px" src="<?php echo e(@$str_profile_image); ?>" class="PaymentProfile">
                                  </div>
                                </div>
                            ...
                            <div class="border rounded  p-3 px-2">
                              <div class="row  mx-0">
                                <div class="col-md-10 col-10 pl-0">
                                  ...
                                  <p class="text-left fontThirteen mb-1">Subscription Id: <?php echo e(@$str_subscription_id); ?></p>
                                  <p class="text-secondary fontThirteen mb-2" id="div-no-invoices-id"><?php echo e(App\Helpers\UtilitiesFour::getLoadingMessage()); ?></p>
                                ...
                                <div class="col-md-2 col-2 pr-0">
                                  <div class="text-right">
                                    <!-- <i class="fa fa-address-book-o fontTwenty photo_icon"></i> -->
                                    <img src="<?php echo e(asset('front/images/PDF.svg')); ?>">
                                  </div>
                                </div>
                                <div class="w-100">
                                  <hr class="mt-0 mb-2">
                                ...
                                <div class="w-100">
                                  ...
                                  ?>
                                    ...
                                    <p>
                                      <a href="<?php echo e(@$st_customer_invoices->hosted_invoice_url); ?>" class="pay_Now invoice_payNow invoiceUrl btn btn-primary font-weight-bold mt-2" style="width:auto;" target="blank" <?php echo e($disabled); ?>>Pay Now $<span class="pay_Price"><?php echo e(number_format(@$st_customer_invoices->amount_remaining/100,2)); ?></span></a>
                                  
                                      <a href="#!" class="pay_Now checkout_payNow btn btn-primary font-weight-bold mt-2" style="width:auto; display:none;" onclick="select_plan('<?php echo e($int_plan_id); ?>'); return false;">Pay Now $<span class="pay_Price"><?php echo e(number_format(@$st_customer_invoices->amount_remaining/100,2)); ?></span></a>

                                      <a href="#!" class="pay_Now coupon_payNow btn btn-primary font-weight-bold mt-2" style="width:auto; display:none;" onclick="save_subscription_new_ajax(0, 0, 1); return false;">Pay Now $<span class="pay_Price"><?php echo e(number_format(@$st_customer_invoices->amount_remaining/100,2)); ?></span></a>

                                      <input type="hidden" name="stripe_coupon_id_hidden" id="stripe_coupon_id_hidden">
                                      <input type="hidden" name="stripe_invoice_renew_id_hidden" id="stripe_invoice_renew_id_hidden" value="<?php echo e(@$st_customer_invoices->id); ?>">
                                    </p>
                                  <?php } ?>
                            ...
                            <div class="border rounded  p-3 px-2">
                              <div class="row  mx-0">
                                ...
                                <div class="col-md-2 col-2 pr-0">
                                  <div class="text-right">
                                    <!-- <i class="fa fa-address-book-o fontTwenty photo_icon"></i> -->
                                    <img src="<?php echo e(asset('front/images/CustomerSupport.svg')); ?>">
                                  </div>
                                </div>
                                <!--<div class="w-100">
                                  <hr class="mt-0 mb-2">
...
<script>
 $(document).ready(function(){
  ...
  function payNow(e,yes_url,no_url){
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo e(route('front.user.site.ajax.invoices.getInvoiceId')); ?>",
      data: {
  ...
  function apply_coupon_code_data(chk_valid){
    ...
    var str_plan_price = '<?php echo e(number_format(@$st_customer_invoices->amount_remaining/100,2)); ?>';
    ...
    $.ajax({
        ...
        success: function (response) {
          if(response.status == 1){
              ...
              $('#stripe_coupon_id_hidden').val('');
              $('#stripe_price_discount_hidden_id').val('');
              var total = '<?php echo e(number_format(@$st_customer_invoices->amount_remaining/100,2)); ?>';
              $('.pay_Price').text(total);
  ...
  function select_plan(id) {
    ...
    function save_subscription_new_ajax(str_session_id, stripe_coupon_id_hidden, int_hundred_discount_flag){
      ...
      $.ajax({
        ...
        data:{
          plan_id: '<?php echo e($int_plan_id); ?>',
          _token: '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('front.profile.include_payment_js_script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php $__env->stopSection(); ?>
