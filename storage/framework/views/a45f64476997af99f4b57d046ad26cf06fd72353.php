...
<style type="text/css">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Submit News </h5>
            ...
            <form id="imagefeedForm"  onsubmit="submit_news_feeds(this); return false;" method="POST" class="popFeedImage" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <div class="popTag">
                      <select name="category" id="select2-multiple-input-sm" class="form-control input-sm select2-multiple category_Id">
                        <option value="">--Select Category--</option>
                        <?php $__currentLoopData = $feeds_categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feeds_categorys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($feeds_categorys->id); ?>"><?php echo e($feeds_categorys->name); ?></option>
  ...
  <script type="text/javascript">
    ...
    function submit_news_feeds(e){
      ...
      $.ajax({
         url:"<?php echo e(route('front.submit_news_feeds')); ?>",
         headers: {
