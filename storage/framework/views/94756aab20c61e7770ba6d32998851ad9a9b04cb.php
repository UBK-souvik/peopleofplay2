...
$(document).ready(function(){
		...
		{
		   get_company_people_list('add_edit_profile_role_name_company_id', '<?php echo e(route("front.user.role.search.company")); ?>', 'add_edit_profile_role_company_hidden_id', 'addRoleModalDivForm');	
		}								/* in the add/edit product for manufacturer list */		if(document.getElementById('product_company_hidden_id'))		{		   get_company_people_list('Company', '<?php echo e(route("front.user.role.search.company")); ?>', 'product_company_hidden_id', 'divProductMainDivIdNew');			}				/* in the add/edit product for brand list */		if(document.getElementById('product_brand_hidden_id'))		{		   get_company_people_list('Brand', '<?php echo e(route("front.user.role.search.brand_list")); ?>', 'product_brand_hidden_id', 'divProductMainDivIdNew');			}
		...
		{
		   get_company_people_list('add_edit_profile_role_name_people_id', '<?php echo e(route("front.user.role.search.people")); ?>', 'add_edit_profile_role_people_hidden_id', 'addRoleModalDivForm');	
		}
		...
		{
		  get_company_people_list('add_edit_profile_role_name_product_id', '<?php echo e(route("front.user.role.search.product")); ?>', 'add_edit_profile_role_product_hidden_id', 'addRoleModalDivForm');
		}
		        /* in the add/edit role modal popup of edit product colloborator for people list */
		if(document.getElementById('collab_user_name'))
		{
		  get_company_people_list('collab_user_name', '<?php echo e(route("front.user.role.search.people")); ?>', 'collab_user_id_hidden', 'AddEditCollabModalForm');
		}
