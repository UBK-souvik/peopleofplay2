...
<?php $__env->startSection('content'); ?>
  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1> Create Wiki Category</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(adminTransLang('dashboard')); ?></a></li>
            <li><a href="<?php echo e(route('admin.wiki.category.index')); ?>"> All Wiki Category </a></li>
            <li class="active">Create Wiki Category</li>
        </ol>
    </section>
    ...
    jQuery(function($) {
      $(document).on('click','#createBtn',function(e){
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "<?php echo e(route('admin.wiki.category.create')); ?>",
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        window.location.replace('<?php echo e(route("admin.wiki.category.index")); ?>');
