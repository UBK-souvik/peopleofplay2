                                    ...
                                    <table class="table table-striped table-bordered no-margin">
                                        <tbody>
                                            <tr>
                                                <th>Main Image</th>
                                                <td>
                                                    <?php if(@$event_profile->main_image): ?>
                                                        <img id="blah" width="100" height="70" src="<?php echo e(imageBasePath($event_profile->main_image)); ?>" class="imgHundred">
                                                    <?php else: ?>
                                            ...
                                            <tr>
                                                <th>Name</th>
                                                <td><?php echo e(@$event_profile->profileName); ?></td>
                                            </tr>
                                            <tr>
                                                <th>URL</th>
                                                <td><a target="_blank" href="<?php echo e(@$event_profile->profileUrl); ?>"><?php echo e(@$event_profile->profileUrl); ?></a></td>
                                            </tr>
                                            <tr>
                                                <th>Subtitle</th>
                                                <td><?php echo e(@$event_profile->profileSubtitle); ?></td>
                                            </tr>
