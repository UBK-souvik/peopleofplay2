               ...
               <form id="addRoleModalDivForm">
                     ...
                     <div class="row">
                        <div class="col-md-6 pl-0">
                           <div class="form-group">
                              <label for="email"><?php echo e(ucfirst($role_type_data_new)); ?> Role:</label>
                        ...
                        <div class="col-md-6 px-0">
                           <div class="form-group">
                              ...
                              <select  id="add_edit_profile_role_at" name="add_edit_profile_role[at]" class="form-control" data-placeholder="Select" onchange="return showProductCompany(this.value);">
                                 ...
                                 <?php if($user->role == 2 && $arr_role_at_list_key>2): ?>
                                 <?php break; ?>
                                 <?php endif; ?>
                  ...
                  <div class="col-md-12">
                     <div class="row">
                        ...
                        <div class="col-md-6 pl-0" id="div-people-list" <?php if($user->role == 3): ?> style="display:block;" <?php else: ?> style="display:none;"  <?php endif; ?>>
                        <div class="form-group">
