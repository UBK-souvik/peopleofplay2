                    ...
                    <div class="box-body">
                        ...
                        <form class="form-horizontal" id="create-form" enctype="multipart/form-data" onsubmit="uploadAdImage(this); return false;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <?php if(!empty($feeds_ad[0]->image)): ?>
                                        <a href="javascript:void(0)" onclick="delAdImg(this,'<?php echo e($feeds_ad[0]->id); ?>'); return false;"><span class="text-danger del_image"><i class="fa fa-times" aria-hidden="true"></i></span></a>
                                        <img id="blah" src="<?php echo e(asset('uploads/images/feeds_ad/'.$feeds_ad[0]->image)); ?>" alt="" class="imgHundred">
                                    <?php else: ?>
                                        <img id="blah" src="<?php echo e(asset('front/new/images/Product/team_new.png')); ?>" alt="" class="imgHundred">
                                    <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <?php if(!empty($feeds_ad[1]->image)): ?>
                                        <a href="javascript:void(0)" onclick="delAdImg(this,'<?php echo e($feeds_ad[1]->id); ?>'); return false;"><span class="text-danger del_image"><i class="fa fa-times" aria-hidden="true"></i></span></a>
                                        <img id="blah_2" src="<?php echo e(asset('uploads/images/feeds_ad/'.$feeds_ad[1]->image)); ?>" alt="" class="imgHundred">
                                    <?php else: ?>
                                        <img id="blah_2" src="<?php echo e(asset('front/new/images/Product/team_new.png')); ?>" alt="" class="imgHundred">
                                    <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <?php if(!empty($feeds_ad[2]->image)): ?>
                                        <a href="javascript:void(0)" onclick="delAdImg(this,'<?php echo e($feeds_ad[2]->id); ?>'); return false;"><span class="text-danger del_image"><i class="fa fa-times" aria-hidden="true"></i></span></a>
                                        <img id="blah_3" src="<?php echo e(asset('uploads/images/feeds_ad/'.$feeds_ad[2]->image)); ?>" alt="" class="imgHundred">
                                    <?php else: ?>
                                        <img id="blah_3" src="<?php echo e(asset('front/new/images/Product/team_new.png')); ?>" alt="" class="imgHundred">
                                    <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <?php if(!empty($feeds_ad[3]->image)): ?>
                                        <a href="javascript:void(0)" onclick="delAdImg(this,'<?php echo e($feeds_ad[3]->id); ?>'); return false;"><span class="text-danger del_image"><i class="fa fa-times" aria-hidden="true"></i></span></a>
                                        <img id="blah_4" src="<?php echo e(asset('uploads/images/feeds_ad/'.$feeds_ad[3]->image)); ?>" alt="" class="imgHundred">
                                    <?php else: ?>
                                        <img id="blah_4" src="<?php echo e(asset('front/new/images/Product/team_new.png')); ?>" alt="" class="imgHundred">
                                    <?php endif; ?>
...
<script type="text/javascript">
    ...
    function uploadAdImage(e){
        ...
        $.ajax({
            processData: false,
            contentType: false,
            url: "<?php echo e(route('admin.FeedsAdController.uploadAdImage')); ?>",
            data: form_data,
            dataType: 'json',
            type: 'POST',
            beforeSend: function()
    ...
    function delAdImg(e,id){
        if(confirm('Are you sure to delete this image?')){
            $.ajax({            
                url: "<?php echo e(route('admin.FeedsAdController.deleteAdImage')); ?>",
                data: {id:id, _token:"<?php echo e(csrf_token()); ?>"},
                dataType: 'json',
                type: 'POST',
                success: function (data){
                    if(data.status == 1){
                        var img_src = "<?php echo e(asset('front/new/images/Product/team_new.png')); ?>";
