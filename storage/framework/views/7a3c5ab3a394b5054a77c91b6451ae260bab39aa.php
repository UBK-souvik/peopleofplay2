...
function show_invoices_data(subscription_invoice_count)
	...
	$.ajax({
                    type: "POST",
                    url: "<?php echo e(route('front.user.site.ajax.invoices.data')); ?>",
                    data: {
                      _token: ajax_csrf_token_new,
	                  current_url_new: '<?php echo e(@$current_page_url_data_new); ?>',
...
$('#cancel-subscription-new').click(function(){
		...
		var stripe = Stripe("<?php echo e(\App\Models\SiteSetting::get_keys(0)); ?>");
