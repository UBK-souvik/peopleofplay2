...
<?php 
    $dashboard = $notes = $home_page = $menu = $profiletype =  $proUser = $basicUser = $freeUser = $propleVerify = $role = $preference = $wiki = $rip = $ytPremieres =  $company = $companyCategory = $product =  $brand = $skill = $productCategory = $productSubCategory = $event = $interviews=
