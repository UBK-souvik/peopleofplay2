  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(route('admin.rest-in-play.category.index')); ?>"> All Rest In Play Category </a></li>
            <li class="active">Create Rest In Play Category</li>
        </ol>
    </section>
    ...
    jQuery(function($) {
      $(document).on('click','#createBtn',function(e){
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "<?php echo e(route('admin.rest-in-play.category.create')); ?>",
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        window.location.replace('<?php echo e(route("admin.rest-in-play.category.index")); ?>');
