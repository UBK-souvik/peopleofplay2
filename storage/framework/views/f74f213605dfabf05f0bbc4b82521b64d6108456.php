...
<div class="col-md-6 col-lg-7 MiddleColumnSection">
   <div class="popFeedBlogs">
      <div class="YTtopContant text-center">
         <img src="<?php echo e(asset('front/images/WebHeader_new.png')); ?>" alt="WelcomeToPOPWeekHeader" class="img-fluid w-100">
      </div>
      <div class="popStartPosts w-100 pt-4 pb-3 border-bottom">
         <form>
            ...
            <input type="hidden" id="dictionary_id" value="<?php echo e(@$dictionary_detail[0]->id); ?>">
         </form>
      </div>
      <?php 
                  ...
                  <div class="dropdown socialDropdown SocialShareBlog">
                     ...
                     <div class="dropdown-content1 socialDropdownContent blogShare dropdown-menu">
                        <ul class="dropSocialShare">
                           <li><a href="javascript:void(0);" onclick="return copySharingUrl(`<?php echo e(@$str_to_meme_url_new); ?>`);"><i class="fa photo_icon fa-clone"></i></a></li>
   ...
   $(document).ready(function() { 
      ...
      function scroll_feeds(function_type=''){
         ...
         if(($(window).scrollTop() >= minus_hgt && load_status == 'active') || (function_type == 'doc_ready')){
            ...
            xhr = $.ajax({
               url: "<?php echo e(route('front.feeds')); ?>",
               headers: {
...
<script>
   ...
   // alert(comment_id);
      $.ajax({
         url: "<?php echo e(route('front.feeds.feed_comment_like_user')); ?>",
         type: 'post',
         dataType: 'json',
