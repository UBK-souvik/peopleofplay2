...
<?php $__env->startSection('title'); ?> All Products <?php $__env->stopSection(); ?>
...
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-success">Create Product</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.product.list")); ?>',
            columns : [
                {
	            ...
	            { "data": "brand" },
                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="<?php echo e(URL::to("admin/product/update")); ?>/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a href="<?php echo e(URL::to("admin/product/view")); ?>/'+row.id+'">\
                                <i class="fa fa-eye fa-fw"></i>\
                            </a>\
                        <a class="delete_admins" href="<?php echo e(URL::to("admin/product/delete")); ?>/'+row.id+'">\
	...
	var product_data_saved_flag = '<?php echo e(Session::has("product_data_saved_flag")); ?>';
