...
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.quiz.create')); ?>" class="btn btn-success">Create Quiz</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
			ajax: '<?php echo e(route("admin.quiz.list")); ?>',
            columns : [
                {
                    "data": "title",
                },
	            { "data": "status" },
                {
                    ...
                    {
						return '<a href="<?php echo e(URL::to("admin/quiz/update")); ?>/'+row.id+'">\<i class="fa fa-edit fa-fw"></i>\</a>\<a class="delete_admins" href="<?php echo e(URL::to("admin/quiz/delete")); ?>/'+row.id+'">\<i class="fa fa-trash fa-fw"></i>\</a>';
                    }, orderable: false
                }
	        ],
            order : [[0, 'desc']]
