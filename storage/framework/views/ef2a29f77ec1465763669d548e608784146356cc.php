                                ...
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body is-active">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="button_text" placeholder="" value="<?php echo e(@$event_description->button_text); ?>">
                                            </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="fun_fact1" class="col-sm-2 control-label">Button Link</label>
                                            <div class="col-sm-6">
                                               <input required type="text" class="form-control" name="button_link" placeholder="" value="<?php echo e(@$event_description->button_link); ?>">
                                            </div>
                                         </div>
                                    </div>
                                </div>
