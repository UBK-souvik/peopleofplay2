            ...
            <th>
               <div class="TableHead text-center pt-4">
                  ...
                  <?php endif; ?>
                    ...
                    <h5 class="text-center mb-0 text-uppercase"><?php echo e($plan->name); ?> </h5>
                  ...
                  <div class="TablePriceBtn pt-2 text-center">
                   <!--<a class="BtnSignUp btn SignUpBtn SignUpFirst button_<?php echo e($plan->type_of_plan); ?>" data-toggle="modal" data-target="#myMaintainance"  href="#">SIGN UP</a>-->
                    <a class="BtnSignUp btn SignUpBtn SignUpFirst button_<?php echo e($plan->type_of_plan); ?>"   href="<?php echo e($register_url . $plan->type_of_plan . '/'. base64_encode($plan->id)); ?>">SIGN UP</a> 
                 </div>
                </div>
               </th>
