<?php //echo "<pre>"; print_r($gallery_data); die; ?>
			...
			<?php $__currentLoopData = $gallery_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery_data_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php  			     
                  ...
                  $str_homa_caption_url_one = $gallery_data_row->homa_caption_url_one;
                  $str_caption_two = $gallery_data_row->home_caption_two;
                  $str_homa_caption_url_two = $gallery_data_row->homa_caption_url_two;
			    ...
			    ?>
					...
					data-src="<?php echo e(@awardImageBasePath(@$str_media_data)); ?>" 
					data-sub-html="<?php echo e($str_bottom_content); ?>">
						<a href="#">
						   <img class="img-responsive img-div-class-new kimg_div_class_new <?php echo e($str_known_for_class); ?> img-fluid" 
						   src="<?php echo e(@awardImageBasePath(@$str_media_data)); ?>">
						</a>
						<div class="userPoductTitle withoutOverlay pt-1 mb-3 text-center">
                        <p class="mb-0">
                        <?php if(!empty($str_caption_one)): ?>
                        
                        <a href="<?php echo e(@$str_homa_caption_url_one); ?>"> <?php echo e($str_caption_one); ?> </a>
                        
                        <?php endif; ?>
                        </p>
                    	
                         <p>
                        <?php if(!empty($str_caption_two)): ?>
                        
                        <a href="<?php echo e(@$str_homa_caption_url_two); ?>"> <?php echo e($str_caption_two); ?> </a>
