  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo e(route('admin.profileheader.index')); ?>"> Header List </a></li>
                    ...
                    <div class="box">
                        <div class="box-body" id="add-edit-user-main-box-body-div">
                            ...
                            <form class="form-horizontal" id="create-form" enctype="multipart/form-data">
                                <input type="hidden" name="header_id" value="<?php echo e(@$profile_header->id); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="accordion">
                                    ...
                                    <div class="accordion__body is-active">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                            <input type="text" class="form-control" name="headerName" placeholder="" value="<?php echo e(@$profile_header->profileHeader); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
      ...
      $(document).on('click','#createBtn',function(e){
        ...
        // alert("ok");
            ...
            $.ajax({
                processData: false,
                contentType: false,
                url: "<?php echo e(route('admin.profileheader.create')); ?>",
                data: fd,
                dataType: 'json',
                type: 'POST',
                beforeSend: function()
                ...
                success: function (data)
                {
                    ...
                    if(data.status == 1)
                    {
                        ...
                        // alert(data.msg);
                        window.location.replace('<?php echo e(route("admin.profileheader.index")); ?>');
