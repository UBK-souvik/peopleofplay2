...
<section class="content">
  ...
  <p>
    <a href="<?php echo e(route('admin.rest-in-play.create')); ?>" class="btn btn-success">Create Rest In Play</a>
  </p>
  <div class="row">
    <div class="col-md-12">
      <div class="box">
...
<script type="text/javascript">
    ...
    $('#navigation-table').DataTable({
     ...
     processing: true,
     serverSide: true,
     ajax: '<?php echo e(route("admin.rest-in-play.list")); ?>',
     columns : [
     {
     ...
     { "data": "status" },
     {
      "mRender": function (data, type, row)
      {
        return '<a href="<?php echo e(URL::to("admin/rest-in-play/view")); ?>/'+row.id+'">\
        <i class="fa fa-eye fa-fw"></i>\
        </a>\
        <a href="<?php echo e(URL::to("admin/rest-in-play/update")); ?>/'+row.id+'">\
        <i class="fa fa-edit fa-fw"></i>\
        </a>\
        <a class="delete_admins" href="<?php echo e(URL::to("admin/rest-in-play/delete")); ?>/'+row.id+'">\
