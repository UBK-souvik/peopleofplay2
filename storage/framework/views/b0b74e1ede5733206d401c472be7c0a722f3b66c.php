...
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
    ...
    <section class="content">
        <?php echo $__env->make('admin.includes.info-box', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		  ...
		  <a href="<?php echo e(route('admin.galleries.showadd')); ?>/1" class="btn btn-success">Create Image Gallery</a>		
		  <a href="<?php echo e(route('admin.galleries.showadd')); ?>/2" class="btn btn-success">Create Video Gallery</a>
		  <a href="<?php echo e(route('admin.galleries.showadd')); ?>/3" class="btn btn-success">Create Known For Gallery</a>
                                   ...
                                   <select class="form-control select2" name="select_gallery_user_id" id="select_gallery_user_id" onchange="return get_gallery_list_by_users(this.value, 0);">
                                     ...
                                     <?php if(count($users_list) > 0): ?>
                                        <?php $__currentLoopData = $users_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users_list_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($users_list_row->id); ?>" <?php echo e((@$user_id  == $users_list_row->id ) ? 'selected' :''); ?>> <?php echo e($users_list_row->text); ?></option>
...
<div class="row">		
		<div class="form-group">
                                ...
                                <div class="col-sm-6">
                                   <select class="form-control select2" name="select_media_id" id="select_media_id" onchange="return get_gallery_list_by_users(<?php echo e(@$user_id); ?>,this.value);">
                                     <option>Select Media</option>
									  <?php $__currentLoopData = $get_gallery_link_types_urls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $get_gallery_link_types_url_key => $get_gallery_link_types_url_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option value="<?php echo e($get_gallery_link_types_url_key); ?>" <?php if(@$int_media_id  == $get_gallery_link_types_url_key): ?><?php echo e('selected'); ?><?php endif; ?>> <?php echo e(ucwords(str_replace('-', ' ', $get_gallery_link_types_url_val))); ?></option>
									  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   </select>
                                </div>
                              </div>					  
...
<?php $__env->startSection('scripts'); ?>
	...
	{
		window.location.href = '<?php echo e(route("admin.galleries.index")); ?>/'+user_id+'/'+media_id;
	}
	
	var str_image_upload_path_new = '<?php echo e(url('/') . $folder_path); ?>';
...
var galleries_table_new = $('#galleries-table').DataTable({
                ...
                ajax: '<?php echo e(route("admin.galleries.list")); ?>/<?php echo e($user_id); ?>/<?php echo e($int_media_id); ?>',
                columns : [
                    { "data": "title" },
					{
                    ...
                    {	
                        ...
                        "mRender": function (data, type, row) 
                        {
                            return '<a href="<?php echo e(route("admin.galleries.showedit")); ?>/'+row.id+'/'+row.type+'">\<i class="fa fa-edit fa-fw"></i>\</a>\<a href="<?php echo e(URL::to("admin/galleries/delete")); ?>/'+row.id+'" class="delete_admins" >\<i class="fa fa-trash fa-fw"></i>\</a>';
                        }, 
                        orderable: false
                    }
                ],
