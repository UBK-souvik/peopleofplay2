    ...
    <script type="text/javascript">
        $(function() {
            $('#users-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route("admin.free.users.list")); ?>',
                columns : [
                    { "data": "name" },
                    { "data": "email" },
                    {
                    ...
                    },
                    {
                        "mRender": function (data, type, row) 
                        {
                            return '<a href="<?php echo e(route("admin.free_users.showedit")); ?>/'+row.id+'">\<i class="fa fa-edit fa-fw"></i></a>\<a href="<?php echo e(URL::to("admin/free_users/view")); ?>/'+row.id+'">\<i class="fa fa-eye fa-fw"></i>\</a>\<a href="<?php echo e(URL::to("admin/users/delete")); ?>/'+row.id+'" class="delete_admins" >\<i class="fa fa-trash fa-fw"></i>\</a>\<a href="<?php echo e(URL::to("admin/free_users/reset-password")); ?>/'+row.id+'" class="danger" >\<i class="fa fa-key fa-fw"></i>\</a>\<a href="<?php echo e(URL::to("admin/mester-login")); ?>/'+row.id+'" class="danger" target="blank">\<i class="fa fa-sign-in fa-fw"></i>\</a>';
                        }, 
                        orderable: false
                    }
                ],
