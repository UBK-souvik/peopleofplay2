...
<body style="background-color: #fff;">
	  ...
	  <div class="container pt-5" style="background-color: #fff;position: relative;width: 650px;min-height: 300px;margin-top: 8%;border:3px solid #662C92;text-align: center;padding: 25px;border-radius: 10px;">
	    ...
	    <p style="margin-top: 6px;margin-bottom: 10px;font-size: 18px;">Hello <?php echo e($name); ?>!</p>
	    <p><?php echo e($sender_name); ?> sent you this message on People of Play:</p>
	    <p style="margin: 2px;font-size: 11px;"><strong><?php echo e($message_data); ?></strong></p>
		<p>Click here to respond: <a href="<?php echo e($message_link); ?>">View</a></p>
