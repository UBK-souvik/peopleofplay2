...
<?php $__env->startSection('title'); ?> All Brands <?php $__env->stopSection(); ?>
...
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.brand_lists.create')); ?>" class="btn btn-success">Create Brand</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
				        <div class="box-body">
				            <table class="table table-striped table-bordered table-hover dataTable" id="navigation-table">
				                <thead>
					                <tr>
                                        <th style="max-width: 100px;">Brand Image</th>
                                        <th>Group</th>
                                        <th>Brand ID</th>
                                        <th>Brand Name</th>
                                        <!-- <th>Price</th> 
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.brand_list.list")); ?>',
            columns : [
                {
	            ...
	            //{ "data": "brand" },
                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="<?php echo e(URL::to("admin/brand_list/update")); ?>/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a href="<?php echo e(URL::to("admin/brand_list/view")); ?>/'+row.id+'">\
                                <i class="fa fa-eye fa-fw"></i>\
                            </a>\
                        <a class="delete_admins" href="<?php echo e(URL::to("admin/brand_list/delete")); ?>/'+row.id+'">\
	...
	var brand_list_data_saved_flag = '<?php echo e(Session::has("brand_list_data_saved_flag")); ?>';

        $(document).ready(function(){
			
		if(brand_list_data_saved_flag!="")
		 {
