...
<?php $__env->startSection('title'); ?> All Entertainment <?php $__env->stopSection(); ?>
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">All Entertainment </li>
  </ol>
</section>
...
<section class="content">
  ...
  <p>
    <a href="<?php echo e(route('admin.entertainment.create')); ?>" class="btn btn-success">Create</a>
  </p>
  <div class="row">
    <div class="col-md-12">
      <div class="box">
...
<script type="text/javascript">
    ...
    $('#navigation-table').DataTable({
     ...
     processing: true,
     serverSide: true,
     ajax: '<?php echo e(route("admin.entertainment.list")); ?>',
     columns : [
     {
     ...
     { "data": "status" },
     {
      "mRender": function (data, type, row)
      {
        return '<a href="<?php echo e(URL::to("admin/entertainment/view")); ?>/'+row.id+'">\
        <i class="fa fa-eye fa-fw"></i>\
        </a>\
        <a href="<?php echo e(URL::to("admin/entertainment/update")); ?>/'+row.id+'">\
        <i class="fa fa-edit fa-fw"></i>\
        </a>\
        <a class="delete_admins" href="<?php echo e(URL::to("admin/entertainment/delete")); ?>/'+row.id+'">\
