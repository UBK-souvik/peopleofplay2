...
<?php $__env->startSection('content'); ?>
    <section class="content-header">
        <h1> <?php echo e(adminTransLang('all_settings')); ?> </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(adminTransLang('dashboard')); ?> </a></li>
            <li class="active"><?php echo e(adminTransLang('all_settings')); ?></li>
        </ol>
    </section>
                ...
                <div class="box">
                    <div class="box-body">
                        <table class="table table-striped table-bordered table-hover dataTable" id="settings-table">
                            <thead>
                                <tr>
                                    <th><?php echo e(adminTransLang('attribute')); ?></th>
                                    <th><?php echo e(adminTransLang('value')); ?></th>
...
<script type="text/javascript">
	$(function() {
        $('#settings-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.settings.list")); ?>',
            columns : [
	            { "data": "label" },
                {
                    "data": "value" ,
                ...
                {
                    "mRender": function (data, type, row) {
                        return '<a href="<?php echo e(URL::to("admin/settings/update")); ?>/'+row.id+'" class="danger">\
