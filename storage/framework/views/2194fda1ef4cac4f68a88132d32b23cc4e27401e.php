...
<section class="content-header">
   <h1>Home Page Award List</h1>
   <ol class="breadcrumb">
      <li><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(adminTransLang('dashboard')); ?></a></li>
      <li class="active">Home Page Award List</li>
   </ol>
</section>
...
<section class="content">
   ...
   <p>
      <a href="<?php echo e(url('admin/cms/home-award/create')); ?>" class="btn btn-success">Create Home Page Award</a>
   </p>
   <div class="row">
      <div class="col-md-12">
         <div class="box">
...
<script type="text/javascript">
   ...
   "pageLength": 50,
           processing: true,
           serverSide: true,
           ajax: '<?php echo e(route("admin.cms.home_page_award_list")); ?>',
           columns : [
   {
   ...
   { "data": "status" },                   
               {
                   "mRender": function (data, type, row) 
                   {
                       return '<a href="<?php echo e(route("admin.cms.home-award.update")); ?>/'+row.id+'">\<i class="fa fa-edit fa-fw"></i>\</a>\<a class="delete_admins" href="<?php echo e(route("admin.cms.home-award.delete")); ?>/'+row.id+'">\<i class="fa fa-trash fa-fw"></i>\</a>';
                   }, 
                   orderable: false
               }
           ],
