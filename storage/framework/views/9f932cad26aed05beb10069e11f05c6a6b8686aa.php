<?php $__env->startSection('title'); ?> <?php echo e(adminTransLang('all_brands')); ?> <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <section class="content-header">
        <h1> <?php echo e(adminTransLang('all_brands')); ?> </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(adminTransLang('dashboard')); ?></a></li>
            <li class="active"><?php echo e(adminTransLang('all_brands')); ?></li>
        </ol>
    </section>
<p id="message-box-id" class="alert alert-block alert-danger message_box hide alert-dismissible"></p>
    ...
    <section class="content">
        <?php echo $__env->make('admin.includes.info-box', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <a href="<?php echo e(route('admin.brands.showadd')); ?>" class="btn btn-success">Create Brand</a>
	    </p>
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable" id="brands-table">
                            <thead>
                                <tr>
									...
									<th><?php echo e(adminTransLang('brand_caption')); ?></th>
    ...
    <script type="text/javascript">
	    $(function() {
            $('#brands-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route("admin.brands.list")); ?>',
                columns : [
          		    { "data": "name" },
					{ "data": "status" },
                    {
                        ...
                        {
                            return '<a href="<?php echo e(route("admin.brands.showedit")); ?>/'+row.id+'">\
                                <i class="fa fa-edit fa-fw"></i>\
                            </a>\
                            <a href="<?php echo e(URL::to("admin/brands/delete")); ?>/'+row.id+'" class="delete_admins" >\
		...
		var brand_data_saved_flag = '<?php echo e(Session::has("brand_data_saved_flag")); ?>';
