...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        <p>
            <a class="btn btn-success btn-floating" href="<?php echo e(route('admin.users.showedit', ['?id' => $user->id])); ?>"><?php echo e(adminTransLang('update')); ?></a>
        </p>
        <div class="row">
            <div class="col-md-12">
                <div class="box">
