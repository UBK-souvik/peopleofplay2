...
<div class="col-md-7 col-lg-8">
   <div class="left-column bg-black1 krow_margin kproduct QuizDetail">
    <div>
        <img src="<?php echo e(asset('front/images/3Truths&ALIEHeader.jpg')); ?>" class="img-fluid">
      </div>
                   ...
                   <div class="dropdown socialDropdown SocialShareBlog mr-1 mt-2">
                           ...
                           <div class="dropdown-content1 socialDropdownContent blogShare dropdown-menu">
                              <ul class="dropSocialShare">
                                 ...
                                 <li><a target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo e(url('/3-truths-and-a-lie?user='.@$question_detail[0]->user->slug)); ?>"><i class="fa photo_icon fa-facebook"></i></a></li>
                                 <li><a target="_blank" href="http://twitter.com/share?url=<?php echo e(url('/3-truths-and-a-lie?user='.@$question_detail[0]->user->slug)); ?>"><i class="fa photo_icon fa-twitter"></i></a></li>
                                 <li><a target="_blank" href="https://www.instagram.com/?url=<?php echo e(url('/3-truths-and-a-lie?user='.@$question_detail[0]->user->slug)); ?>"><i class="fa photo_icon fa-instagram"></i></a></li>
                                 <li><a target="_blank" href="https://wa.me/?text=<?php echo e(url('/3-truths-and-a-lie?user='.@$question_detail[0]->user->slug)); ?>"><i class="fa photo_icon fa-whatsapp"></i></a></li>
                              </ul>
                           </div>
                        </div>
            </div>
...
<?php echo $__env->make("front/includes/advertisement_quiz", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>
...
<script>
   ...
   // Event Form
        ...
        var fd = new FormData($('#quiz-form')[0]); 
               ...
               $.ajax({
                   url: "<?php echo e(route('front.user.quiz.save')); ?>",
          headers: {
