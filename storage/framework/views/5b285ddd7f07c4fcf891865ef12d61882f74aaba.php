...
?>
  <a href="<?php echo e(@$redirect); ?>">
    <div class="kbox_wrap_inner d-flex justify-content-start p-2 first_box boxWidth">
       <div class="mr-2">
          <img class="awardNomineeImg" src="<?php echo e($str_image_path); ?>">
       </div>
       <div class="pull-left w-100">
          <div class="w-100 d-flex justify-content-start">
            <div class="popFavInner">
              <p class="mb-0 mr-2"> <a href="<?php echo e(@$redirect); ?>" class="alinks_header"><?php echo e($str_name_data); ?></a></p>
            </div>
            <div class="pull-right popFavnner">
              <a class="text-danger removeWatchList" type="button" onclick="return confirm('Are you sure?')" href="<?php echo e($str_remove_watch_list_link); ?>">
                <i class="fa fa-times-circle-o"></i>
              </a>
            </div>
          </div>
          <div>
            <p class="mb-0 p-text"><?php echo @App\Helpers\Utilities::getFilterDescriptionHome($str_description, 3); ?> <a href="#" data-toggle="modal" class="readMore" data-target="#wathchListDetail<?php echo e($int_row_id); ?>">Read More...</a></p>
          </div>
       </div>
    </div>
  </a>
	  ...
	  <div class="modal" id="wathchListDetail<?php echo e($int_row_id); ?>">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div>
              <p class="text-justify p-text"><?php echo @$str_description; ?></p>
            </div>
          </div>
        </div>
      </div>
