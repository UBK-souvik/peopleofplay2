...
<?php $__env->startSection('content'); ?>
	...
	<!-- Content Header (Page header) -->
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.event2022.create')); ?>" class="btn btn-success">Create Event</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.event.list")); ?>',
            columns : [
	            {
	            ...
	            {
                    mRender: function(data,type,row) {
                        return '<a href="<?php echo e(URL::to("admin/award/")); ?>/'+row.id+'">Add Awards</a>'
                    }
                ...
                },
                {
                    "mRender": function (data, type, row)
                    {
                        return '<a href="<?php echo e(URL::to("admin/events/update")); ?>/'+row.id+'">\
                            <i class="fa fa-edit fa-fw"></i>\
                        </a>\
                        <a href="<?php echo e(URL::to("admin/events/view")); ?>/'+row.id+'">\
                            <i class="fa fa-eye fa-fw"></i>\
                        </a>\
                        <a class="delete_admins" href="<?php echo e(URL::to("admin/events/delete")); ?>/'+row.id+'">\
