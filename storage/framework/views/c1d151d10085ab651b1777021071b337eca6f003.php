            ...
            <div class="row ">
              <div class="col-md-12">
                <?php if(!empty($user->first_name)): ?>
                    <p class="text-black p-0 mb-1"><strong>Primary Email</strong> : <?php echo e(@$user->first_name .' '. @$user->last_name); ?></p>
                ...
                <?php if(!empty($user->mobile)): ?>
                    ...
                    <p class="text-black p-0 mb-1"><strong>Primary Mobile</strong> : <?php echo e(@$user->mobile); ?></p>

                <?php endif; ?>

                <?php if(!empty($user->website)): ?>

                    <p class="text-black p-0 mb-1"><strong>Website</strong> : <?php echo e(@$user->website); ?></p>
        ...
        <div class="feed-main-box">
             <div class="feed-box bg-box-shadow">
                <div class="w-100 clearfix feed-profile d-flex ">
                    <div class="profile-img w-50 d-flex align-items-center">
                        <div class="prof-image mr-2">
                            <img src="<?php echo e(asset('front/images/image1.jpg')); ?>" alt="profileimage" class="img-fluid rounded-circle">
                        </div>
                        <div class="Prof-name">
                ...
                <div class="feed-image-post">
                     <img src="<?php echo e(asset('front/images/lego_toys_img.jpeg')); ?>" alt="lego_toys_img" class="img-fluid">
                </div>
