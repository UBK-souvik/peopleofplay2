        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <button type="button"
                        onclick="return location = '<?php echo e(route('front.user.award.create')); ?>'"
                    ...
                    <table class="table kproductTbl">
                        ...
                        <tbody class="tbody_productlist">
                            <?php if(count($award_list) > 0): ?>
                                <?php $__currentLoopData = $award_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $award_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><img width="50" src="<?php echo e(@awardUserImageBasePath(@$award_row->featured_image)); ?>" class="imgfifty" > </td>
                                        <td class="verticalalign"><?php echo e($award_row->title); ?></td>
                                        <td class="verticalalign"><?php echo e($award_row->created_at); ?></td>
    									<td class="verticalalign">
                                            <span class="table-edit">
                                                <a href="<?php echo e(route('front.user.award.update',$award_row->id ?? '')); ?>" 
                                                    class="span-style1 my-0">Edit</a>
                                            </span>
                                        </td>
                                        <td class="verticalalign">
                                            <span class="table-delete">
                                                <a href="<?php echo e(route('front.user.award.delete',$award_row->id ?? '')); ?>"
