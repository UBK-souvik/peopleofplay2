...
<section class="content">
  ...
  <p>
    <a href="<?php echo e(route('admin.wiki.create')); ?>" class="btn btn-success">Create Wiki</a>
  </p>
  <div class="row">
    <div class="col-md-12">
      <div class="box">
...
<script type="text/javascript">
    ...
    $('#navigation-table').DataTable({
     ...
     processing: true,
     serverSide: true,
     ajax: '<?php echo e(route("admin.wiki.list")); ?>',
     columns : [
     {
     ...
     { "data": "status" },
     {
      "mRender": function (data, type, row)
      {
        return '<a href="<?php echo e(URL::to("admin/wiki/view")); ?>/'+row.id+'">\
        <i class="fa fa-eye fa-fw"></i>\
        </a>\
        <a href="<?php echo e(URL::to("admin/wiki/update")); ?>/'+row.id+'">\
        <i class="fa fa-edit fa-fw"></i>\
        </a>\
        <a class="delete_admins" href="<?php echo e(URL::to("admin/wiki/delete")); ?>/'+row.id+'">\
