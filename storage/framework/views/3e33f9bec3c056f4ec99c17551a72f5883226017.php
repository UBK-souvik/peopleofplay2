...
<?php $__env->startSection('content'); ?>
	...
	<!-- Content Header (Page header) -->
        <section class="content-header">
            <h1> All Cast Category </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(adminTransLang('dashboard')); ?></a></li>
                <li class="active">All Cast Category</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <p>
                <a href="<?php echo e(route('admin.cast.category.create')); ?>" class="btn btn-success">Create</a>
            </p>
            <div class="row">
                <div class="col-md-12">
				    <div class="box">
...
<script type="text/javascript">
	$(function() {
        $('#navigation-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo e(route("admin.cast.category.list")); ?>',
            columns : [
	            { "data": "name" },
                { "data": "description" },
                { "data": "status" },
        ...
        $('#navigation-table').on('click', '.delete_admins', function(e){
            ...
            if (r == false) {
             ...
             if($(this).attr('href') == 'javascript:void(0);') {
                 var r = confirm("<?php echo e('Cannot delete this category because it has been used Cast.'); ?>");
                  return false;
            }
